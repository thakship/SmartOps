...
$sql_diif = "SELECT chk.cat_code AS Department,
                     ...
                     CONCAT(count(*), ' Issues Pending for your review: Escallation - II')  as Message_Subject
               ...
               WHERE chk.cmb_code = '5001'
                 ...
                 AND us.userName = sc.ESCAL_2_USER_ID
                 AND sc.ESCAL_2 < DATEDIFF(NOW(),DATE(chk.enterDateTime)) 
                 AND sc.SLA_TYPE = 'DAY'
