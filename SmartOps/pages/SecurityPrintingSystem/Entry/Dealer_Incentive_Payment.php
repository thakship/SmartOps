...
Page Name		: Dealer Incentive Payment
Purpose			: For Generate Incentive Payment Payment
Author			: Nilanka chameera
Date & Time		: 01.00 P.M 13/09/2018
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
	$_SESSION['page']="sps/e/013";
...
<script type="text/javascript">
   function pageRef(){
     window.open('http://cdberp:8080/cdb/pages/SecurityPrintingSystem/Entry/Dealer_Incentive_Payment.php?DispName=Memo%20of%20Advicing%20for%20introducer%20Payment','conectpage');
   }
        ...
        function isRequest(){
            ...
            var txtEnrtyUser = document.getElementById("txtMyUserID").value;
                ...
                getdata.open("GET","../SPS_DEVELOPMENT/PHP_FUNCTION/SPS_php_function.php"+"?getFacilityNumberMDP="+txtFacilityNumber+"&getEnrtyUserMDP="+txtEnrtyUser,true);
                getdata.send();
            //alert("C");
        }
