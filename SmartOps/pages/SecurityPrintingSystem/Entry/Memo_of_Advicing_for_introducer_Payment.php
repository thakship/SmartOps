...
Page Name		: Memo of Advicing for introducer Payment
Purpose			: For Generate introducer Payment
Author			: Madushan Wikramaarachchi
Date & Time		: 11.23 A.M 04/07/2018
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
	$_SESSION['page']="sps/e/009";
     ...
     window.open('http://cdberp:8080/cdb/pages/SecurityPrintingSystem/Entry/Memo_of_Advicing_for_introducer_Payment.php?DispName=Memo%20of%20Advicing%20for%20introducer%20Payment','conectpage');
        ...
        function isRequest(){
            ...
            var txtEnrtyUser = document.getElementById("txtMyUserID").value;
                ...
                getdata.open("GET","../SPS_DEVELOPMENT/PHP_FUNCTION/SPS_php_function.php"+"?getFacilityNumberMIP="+txtFacilityNumber+"&getEnrtyUserMIP="+txtEnrtyUser,true);
                getdata.send();
            //alert("C");
        }
