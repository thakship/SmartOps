...
Page Name		: kiosk completed Report
Purpose			:  for completed kiosk - given period
Author			: Madushan Wikramaarachchi
Date & Time		: 12.32 P.M 07/12/2015
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
	$_SESSION['page']="hel/r/005";
...
function getGriedViwe(){
        ...
        if(getFromDate == ""){
            ...
            mydata.open("GET","ajax_report_helpdesk.php"+"?getKISCompteFromDate_HR="+getFromDate+"&getKISCompteToDate_HR="+getToDate,true);
            mydata.send();
        }
...
<span style='margin-left: 40px;'>After 5pm submission will be treated as next day 8:30am submission</span>
