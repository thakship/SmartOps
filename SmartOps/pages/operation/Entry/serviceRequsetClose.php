...
<?php
    ...
    $v_sql_select = "SELECT `helpid`, DATE(`enterDateTime`) AS getDate,`issue` FROM `cdb_helpdesk` WHERE `cdb_helpdesk`.`cat_code` = '1014' and `cdb_helpdesk`.`enterBy` = '".$_SESSION['user']."' AND `cdb_helpdesk`.`cmb_code` = '5001' UNION ALL SELECT `helpid`, DATE(`enterDateTime`) AS getDate,`issue` FROM `cdb_helpdesk` WHERE `cdb_helpdesk`.`cat_code` <> '1014' and `cdb_helpdesk`.`cmb_code` = '5001' AND `cdb_helpdesk`.`entry_branch` = '".$_SESSION['userBranch']."' AND `cdb_helpdesk`.`entry_department` = '".$_SESSION['userDepartment']."';";
    //echo $v_sql_select;
