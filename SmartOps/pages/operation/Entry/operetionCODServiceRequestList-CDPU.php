...
function clientValidate(title,cat_cod){
    ...
    if(cat_cod != '1014' ){
        ...
        mydata.open("GET","../Operation_DEVELOPMENT/PHP_FUNCTION/operation_Ajax.php"+"?getHelpIDreqqc="+getHI+"&gettxt_helpdesk_closeqc="+helpClose,true);
        mydata.send();
    }
  ...
  var key = event.keyCode || event.which;
   ...
   if(key == 120){ // F9
       ...
       var mydataNew;
        ...
        var userID = document.getElementById('txt_USERMY').value;
        var userg = document.getElementById('txt_USERgROUP').value;
		mydataNew.open('GET','ajaxEntryNewGrid_F2_CDPU.php'+'?n_userID='+userID+'&n_userg='+userg,true);
		mydataNew.send();
       ...
       var mydataNew;
        ...
        var userID = document.getElementById('txt_USERMY').value;
        var userg = document.getElementById('txt_USERgROUP').value;
		mydataNew.open('GET','ajaxEntryNewGrid_F10_CDPU.php'+'?n_userID='+userID+'&n_userg='+userg,true);
		mydataNew.send();
       ...
       var mydataNew;
        ...
        var userID = document.getElementById('txt_USERMY').value;
        var userg = document.getElementById('txt_USERgROUP').value;
		mydataNew.open('GET','ajaxEntryNewGrid_F8_CDPU.php'+'?n_userID='+userID+'&n_userg='+userg,true);
		mydataNew.send();
    }
}
</script>
...
<?php
 ...
 WHERE `cdb_helpdesk`.`ur_code` = `urgency_states`.`ur_code` AND
	   ...
	   `cdb_helpdesk`.`QC_CDPU_ON` IS NULL
       ORDER BY `cdb_helpdesk`.`helpid`;";
