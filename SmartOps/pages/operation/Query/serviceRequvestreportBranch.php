...
<table>
     <tr>
        ...
        <td style="text-align:left; padding-top:5px; padding-bottom:5;width:150px;">
            <select class="box_decaretion"  style="width: 130px;" name="sel_States" id="sel_States" onkeypress="return disableEnterKey(event)" title="1"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)">
                <option value="">--Select States --</option>
            <?php
                $v_sql_States = "SELECT `cmb_code`,`cmb_discr` FROM `cmb_states` WHERE `cmb_state` = 1 AND `cmb_code` != 5005;";
        ...
        <td style="text-align:left; padding-top:5px; padding-bottom:5;width:150px;">
            <select class="box_decaretion"  style="width: 130px;" name="sel_Urgency" id="sel_Urgency" onkeypress="return disableEnterKey(event)" title="2" onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)">
        ...
        <td style="text-align:left; padding-top:5px; padding-bottom:5;width:150px;">
           <select class="box_decaretion"  style="width: 130px;" name="sel_Priority" id="sel_Priority" onkeypress="return disableEnterKey(event)" title="3" onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)">
        ...
        <td style="text-align:left; padding-top:5px; padding-bottom:5;width:150px;">
           <select class="box_decaretion"  style="width: 150px;" name="sel_Source" id="sel_Source" onkeypress="return disableEnterKey(event)" title="4"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)">
        ...
        <td style="text-align:left; padding-top:5px; padding-bottom:5;width:150px;">
           <select class="box_decaretion"  style="width:150px;" name="sel_User" id="sel_User" onkeypress="return disableEnterKey(event)" title="5"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)">
        ...
        <td style="text-align:left; padding-top:5px; padding-bottom:5;width:150px; display: none;">
           <select class="box_decaretion"  style="width:200px;" name="sel_catCode" id="sel_catCode" onkeypress="return disableEnterKey(event)" title="6"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)">
            <option value="">--Select Sub Category. --</option>
            <?php
                $v_sql_userAse = "SELECT DISTINCT c.scat_code_1 AS scat_code_1, s.scat_discr_1 AS scat_discr_1
                                    FROM cdb_helpdesk AS c , cdb_help_user_oth AS o , scat_01 AS s
                                    WHERE c.cat_code = o.cat_code AND
                                          c.scat_code_1 = s.scat_code_1 AND
                                          o.user_group = '".$_SESSION['usergroupNumber']."'
                                    ORDER BY c.enterDateTime DESC;";
                $que_userAse = mysqli_query($conn,$v_sql_userAse);
                while($RES_userAse = mysqli_fetch_array($que_userAse)){
                    echo "<option value=".$RES_userAse[0].">".$RES_userAse[1]."</option>";
                }
            ?>
            </select>
        </td>
...
<table border="1" cellpadding="0" cellspacing="0" id="myTable"  style="background:#FFFFFF;text-align:center; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
       ...
       /* $v_sql_det_detels = "SELECT `cdb_helpdesk`.`helpid` , 
                                     ...
                                     replace(`cdb_helpdesk`.`issue`,CHAR(150),'') , 
                                     `branch`.`branchName`, 
                                     ...
                                     DATE(`cdb_helpdesk`.`solved_on`),  
                                     `cdb_helpdesk`.`act_by`, 
                                      DATE(`cdb_helpdesk`.`act_on`) ,
