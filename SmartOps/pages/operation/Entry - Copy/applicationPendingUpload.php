...
<table id="trScat02" style="display: none;">
  <tr style="vertical-align: top;">
    ...
    <td>
   	     <select class="box_decaretion"  style="width: 200px;" name="sel_Select_Category_02" id="sel_Select_Category_02" onkeypress="return disableEnterKey(event)"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)" onchange="getNewFiledScat02();">
                    ...
                    if($_FILES["fileAttachment"]["error"] > 0){
    				   ...
    				   $_SESSION['fileAttachment'] = $TableID.$_FILES["fileAttachment"]["name"];
                        if(file_exists("C:/wamp64/www/CDB/uploadHelpdesk/" .$_SESSION['fileAttachment'])){
                            ...
                            $sql_insert = "INSERT INTO `pending_upload_file`(`file_type`, `help_id`, `ai_serial_number`, `file_name`, `file_path`, `ai_file_name`, `done_by`, `done_on`, `flag` , `remark` ,`DocPurpose`,`scat02`)  
                                                                    VALUES ('".$_POST['txt_aIType']."','".$_POST['txt_Help_ID']."','".$batch_num."','".$_FILES["fileAttachment"]["name"]."','C:/wamp64/www/CDB/uploadHelpdesk/','".$_SESSION['fileAttachment']."','".$_SESSION['user']."',now(),0,'".$_POST['textRemark']."','".$_POST['sel_Purpose']."','".$_POST['sel_Select_Category_02']."');";
