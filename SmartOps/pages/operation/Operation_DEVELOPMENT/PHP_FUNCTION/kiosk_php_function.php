<?php
    ...
    if(isset($_POST['get_assuser'])){
        ...
        is_update_COD_FILE_PROCUSER(trim($_POST['get_assuser']),trim($_POST['get_aass_ksrl_helpid'])); // 2017-01-30 (Madushan)
 ...
 //   if(isset($_POST['getCDPUQCUserrmvlodge']) && isset($_POST['getCDPUQCHelpIDrmvlodge']) && isset($_POST['getPageTitle']) && isset($_POST['getrmv_officer'])){
   ...
   if(isset($_POST['getCDPUQCUserrmvlodge']) && isset($_POST['getCDPUQCHelpIDrmvlodge']) && isset($_POST['getPageTitle']) && isset($_POST['getrmv_officer']) && isset($_POST['getrmv_vehicle']) && isset($_POST['getrmv_Cr_Stat_name']) && isset($_POST['getrmv_Cr_Stat_code']) && isset($_POST['RMV_PAMT']) && isset($_POST['Licensing_Authority']) ){
               is_update_rmv_updated($_POST['getCDPUQCUserrmvlodge'],$_POST['getCDPUQCHelpIDrmvlodge'],$_POST['getPageTitle'],$_POST['getrmv_officer'], $_POST['getrmv_vehicle'] , $_POST['getrmv_Cr_Stat_name'] , $_POST['getrmv_Cr_Stat_code'], $_POST['RMV_PAMT'] ,  $_POST['Licensing_Authority']);
            
        
    }
    
    if(isset($_POST['getCDPUQCUserrmvlodgeext']) && isset($_POST['getCDPUQCHelpIDrmvlodgeext']) && isset($_POST['getPageTitleext']) && isset($_POST['getrmv_officerext']) && isset($_POST['getrmv_vehicleext']) && isset($_POST['getrmv_Cr_Stat_nameext']) && isset($_POST['getrmv_Cr_Stat_codeext']) && isset($_POST['RMV_PAMText']) && isset($_POST['Licensing_Authorityext']) ){
               is_update_rmv_updated_extract($_POST['getCDPUQCUserrmvlodgeext'],$_POST['getCDPUQCHelpIDrmvlodgeext'],$_POST['getPageTitleext'],$_POST['getrmv_officerext'], $_POST['getrmv_vehicleext'] , $_POST['getrmv_Cr_Stat_nameext'] , $_POST['getrmv_Cr_Stat_codeext'], $_POST['RMV_PAMText'] ,  $_POST['Licensing_Authorityext']);
            
        
    }
    
    if(isset($_POST['getCDPUQCUserrmvlodgecash']) && isset($_POST['getCDPUQCHelpIDrmvlodgecash']) && isset($_POST['getPageTitlecash']) && isset($_POST['getrmv_officercash']) && isset($_POST['getrmv_vehiclecash']) && isset($_POST['getrmv_Cr_Stat_namecash']) && isset($_POST['getrmv_Cr_Stat_codecash']) && isset($_POST['RMV_PAMTcash']) && isset($_POST['Licensing_Authoritycash']) ){
      // data: {getCDPUQCUserrmvlodgecash : ksrl_user  , getCDPUQCHelpIDrmvlodgecash : ksrl_helpid , getPageTitlecash : 'RMVLodge' ,getrmv_officercash : rmv_officer, getrmv_vehiclecash : rmv_vehicle , getrmv_Cr_Stat_namecash : rmv_Cr_Stat_name ,getrmv_Cr_Stat_codecash : rmv_Cr_Stat_code ,RMV_PAMTcash : txt_RMVPayment , Licensing_Authoritycash : txt_Licensing_Authority},
               is_update_rmv_updated_cash($_POST['getCDPUQCUserrmvlodgecash'],$_POST['getCDPUQCHelpIDrmvlodgecash'],$_POST['getPageTitlecash'],$_POST['getrmv_officercash'], $_POST['getrmv_vehiclecash'] , $_POST['getrmv_Cr_Stat_namecash'] , $_POST['getrmv_Cr_Stat_codecash'], $_POST['RMV_PAMTcash'] ,  $_POST['Licensing_Authoritycash']);
    ...
    if(isset($_POST['get_rmv_user']) && isset($_POST['isRMVbatch_ID'])){
        // echo $_POST['get_rmv_user'] ." - ".$_POST['isRMVbatch_ID'];
         get_print_Payment_Gen($_POST['get_rmv_user'],$_POST['isRMVbatch_ID']);
    ...
    function get_print_Payment_Gen($get_rmv_user,$get_isRMVbatch_ID){
    ...
    $today = date("g:i a");
        ...
        try{
            date_default_timezone_set('Asia/Colombo');
            $sql_update = "UPDATE `rmv_batch_header` 
                                SET `print_status`= '1' ,
                                    `printBy` = '".$get_rmv_user."' ,
                                    `printOn` = now()
                                WHERE `batch_id` = '".$get_isRMVbatch_ID."'";
           //echo $sql_update;
    ...
    $sql_get_cbl05_tbl_data = "select * from rmv_batch_header s where s.batch_id = ".$get_isRMVbatch_ID.";";
    ...
    $sql_rmv_off_dtl = "select ro.RMV_OFFICER_NAME_FULL , ro.officer_acc_no
                            from rmv_header AS rh ,  rmv_officers AS ro 
                            WHERE rh.RMV_OFFICER = ro.Rmv_Officer_Name
                            AND rh.PAYMENT_BATCH = ".$get_isRMVbatch_ID."
                            GROUP BY ro.RMV_OFFICER_NAME_FULL , ro.officer_acc_no";
    $query_rmv_off_dtl = mysqli_query($conn,$sql_rmv_off_dtl) or die(mysqli_error($conn));
    $RMV_OFFICER_NAME_FULL = "";
    $officer_acc_no = "";
    while($result_rmv_off_dtl = mysqli_fetch_array($query_rmv_off_dtl)){
        $RMV_OFFICER_NAME_FULL = $result_rmv_off_dtl[0];
        $officer_acc_no  = $result_rmv_off_dtl[1];
    }
    
    
    //-------- END OF MAIN WHILE
echo "<div style='page-break-after: always;font-family: sans; font-size: 10px;' id='cover'>
        <h3 style='font-family: sans;text-align:center;'>CITIZENS DEVELOPMENT BUSINESS FINANCE PLC </h3>
        <h3 style='font-family: sans;text-align:center;'>RMV CHARGES PAYABLE TO Mr.".$RMV_OFFICER_NAME_FULL." of Savings Account No. ".$officer_acc_no."  </h3> 
        
        <div style='font-family: Verdana, Arial, Helvetica, sans-serif;   font-size: 10px; text-align: right; position: absolute; top:0; right:0;'>        
                <label style='font-family: sans;font-size: 12px;'>Batch No   : ".$result_tbl_data['batch_id']." </label><br />
                <label style='font-family: sans;font-size: 12px;'>Print User : ".$get_rmv_user."</label><br />
                <label style='font-family: sans;font-size: 12px;'>Print Date : ".date('F j, Y')." </label><br />
                <label style='font-family: sans;font-size: 12px;'>Print Time :".$today."</label><br />
        </div>
           
        <table  border='1' cellpadding='4' cellspacing='0' style='padding: 0px;font-family: sans;font-size: 10px;'>
          <tr>
            <th >S/N</th>
            <th >Lodge Date</th>
            <th >Facility No</th>
            <th <col width='250' >Client Name</th>
            <th >Debited Amount</th>
            <th >Payable Amount</th>
            <th >Vehicle No</th>
            <th >License</th>
            <th >TAX</th>
            <th >Lodged Officer</th>   
          </tr>";
          $sql_rmv_header = "select * from  rmv_header AS r WHERE r.PAYMENT_BATCH = ".$get_isRMVbatch_ID.";";
          $query_rmv_header = mysqli_query($conn,$sql_rmv_header) or die(mysqli_error($conn));
          $x = 1;
          $RmvPayableAmount = 0.00;
          while($resalt_rmv_header = mysqli_fetch_assoc($query_rmv_header)){
            $sql_select_helpdesk = "select ch.issue from  cdb_helpdesk AS ch WHERE ch.helpid = '".$resalt_rmv_header['helpid']."';";
            $query_select_helpdesk = mysqli_query($conn,$sql_select_helpdesk) or die(mysqli_error($conn));
            $iss = "";
            while($rec_select_helpdesk = mysqli_fetch_array($query_select_helpdesk)){
                $iss = $rec_select_helpdesk[0];
            }
            ...
            echo "<tr>
                    <td>".$x.".</td>
                    <td>".date('j F, Y',strtotime($resalt_rmv_header['RMV_Q_START_DATE']))."</td>
                    <td>".$resalt_rmv_header['Facno']."</td>
                    <td>".$iss."</td>
                    <td>".number_format($resalt_rmv_header['RmvDebitedAmount'],2)."</td>
                    <td>".number_format($resalt_rmv_header['RmvPayableAmount'],2)."</td>
                    <td>".$resalt_rmv_header['CR_VehicleNo']."</td>
                    <td>".$resalt_rmv_header['Licensing_Authority']."</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>";
                $x++;
                $RmvPayableAmount += $resalt_rmv_header['RmvPayableAmount'];
          }
            
            echo "<tr>
                <td colspan='5' style='text-align: right;'>Total Amount</td>
                <td>".number_format($RmvPayableAmount,2)."</td>
                <td colspan='4'>Total No of transactions : ".--$x." </td>
            </tr>
        </table>
        
        <br /><br />  
        <p style='font-family: sans;font-size: 10px;font-weight: bold;'>Total Number of Transactions : ".$x." </p>
        <p style='font-family: sans;font-size: 10px;font-weight: bold;'>I hereby confirm that I have submitted the original CR along with other RMV related documents pretaning to the above facilities.   I will take all the responsibility of Original CR / Original Licence which I handed over to Custodian unit. </p>
        <p style='font-family: sans;font-size: 10px;'>I acknowledge the RMV Payable amount of Rs. ".$RmvPayableAmount." of above ".$x++." RMV transactions</p>
        <span style='font-family: sans;font-size: 10px;'>.....................................................</span><br />
        <span style='font-family: sans;font-size: 10px;'>".$RMV_OFFICER_NAME_FULL."</span><br /><br />
         <p style='font-family: sans;font-size: 10px;'>This to Confirm you that the Mr.(RMV Officer) Being the RMV charges payable for above facilities.Saving account no :  (RMV Officers Savings Account No)</p>
        
        <table style='width: 58%;'>
            <tr>
                <td style='text-align: left;'><span style='font-family: sans;font-size: 10px;'>.............................................</span></td>
                <td style='text-align: left;'><span style='font-family: sans;font-size: 10px;'>.............................................</span></td>
                <td style='text-align: left;'><span style='font-family: sans;font-size: 10px;'>.............................................</span></td>
            </tr>
             <tr>
                <td style='text-align: left;'><span style='font-family: sans;font-size: 10px;'>Prepared By</span></td>
                <td style='text-align: left;'><span style='font-family: sans;font-size: 10px;'>Checked by</span></td>
                <td style='text-align: left;'><span style='font-family: sans;font-size: 10px;'>Approved by</span></td>
            </tr>
        </table>
        ...
        <table border='1' cellpadding='4' cellspacing='0' style='padding: 0px;font-family: sans;font-size: 10px;'>
            <tr>
                ...
                <th style='text-align: left; width:500px'>Reject Documents / Comments (If applicable)</th> 
            </tr>
            <tr>
                ...
                <td>   
                    ...
                    <table>
                        <tr>
                         ...
                         <tr>
                            <td style='text-align: left;width:400px; '>Lalaka  </td>
                            <td style='text-align: left;width:400px; '>RMV Unit </td> 
                        </tr>
                    </table>
                </td>
            </tr>
    ...
    function is_update_rmv_updated($getCDPUQCUserrmvlodge,$getCDPUQCHelpIDrmvlodge,$page_title, $rmv_officer , $rmv_vehicle , $rmv_Cr_Stat_name,$rmv_Cr_Stat_code,$RMV_PAMT , $Licensing_Authority){
         $conn = DatabaseConnection();
        mysqli_autocommit($conn,FALSE);
        try{
            // Validation rule engine
               ...
               if ($page_title == 'RMVToBeReceived'){
    				$sql_update   = "update `rmv_header` 
                                        set `rmv_header`.`CR_ReceivedBy` = '".$getCDPUQCUserrmvlodge."' ,
                                             ...
                                             `rmv_header`.`Licensing_Authority` = '".$Licensing_Authority."',
 ...
 //   ['getCDPUQCUserrmvlodgeext']) && isset($_POST['getCDPUQCHelpIDrmvlodgeext']) && isset($_POST['getPageTitleext']) && isset($_POST['getrmv_officerext']) && isset($_POST['getrmv_vehicleext']) && isset($_POST['getrmv_Cr_Stat_nameext']) && isset($_POST['getrmv_Cr_Stat_codeext']) && isset($_POST['RMV_PAMText']) && isset($_POST['Licensing_Authorityext']) ){
 function is_update_rmv_updated_extract($getCDPUQCUserrmvlodgeext,$getCDPUQCHelpIDrmvlodgeext,$page_titleext, $rmv_officerext , $rmv_vehicleext , $rmv_Cr_Stat_nameext,$rmv_Cr_Stat_codeext,$RMV_PAMText , $Licensing_Authorityext){
         $conn = DatabaseConnection();
        mysqli_autocommit($conn,FALSE);
        try{
            // Validation rule engine
            date_default_timezone_set('Asia/Colombo');
             ...
             if($page_titleext == 'RMVLodge'){
                 //echo $getCDPUQCUserrmvlodgeext. "  -  ".$getCDPUQCHelpIDrmvlodgeext;
                   $sql_update = "UPDATE `rmv_header` 
                                     SET  `RmvLogBy`='".$getCDPUQCUserrmvlodgeext."',
                                          `RmvLogDate`=NOW() ,
                                          `RmvPayableAmount` = ".$RMV_PAMText." ,
                                          `RMV_OFFICER`= '".$rmv_officerext."' ,
                                          `Extract_By`='".$getCDPUQCUserrmvlodgeext."',
                                          `Extract_on`=NOW() ,
                                          `Extract_Req` = 1
                                   WHERE `helpid` = '".$getCDPUQCHelpIDrmvlodgeext."';";
                    //echo $sql_update." -- ";
                    $query_update =  mysqli_query($conn,$sql_update) or die(mysqli_error($conn));
             }
    ...
    //                is_update_rmv_updated_cash($_POST['getCDPUQCUserrmvlodgecash'],$_POST['getCDPUQCHelpIDrmvlodgecash'],$_POST['getPageTitlecash'],$_POST['getrmv_officercash'], $_POST['getrmv_vehiclecash'] , $_POST['getrmv_Cr_Stat_namecash'] , $_POST['getrmv_Cr_Stat_codecash'], $_POST['RMV_PAMTcash'] ,  $_POST['Licensing_Authoritycash']);
    function is_update_rmv_updated_cash($getCDPUQCUserrmvlodgecash,$getCDPUQCHelpIDrmvlodgecash,$page_titlecash, $rmv_officercash , $rmv_vehiclecash , $rmv_Cr_Stat_namecash,$rmv_Cr_Stat_codecash,$RMV_PAMTcash , $Licensing_Authoritycash){
         $conn = DatabaseConnection();
        mysqli_autocommit($conn,FALSE);
        try{
            // Validation rule engine
            date_default_timezone_set('Asia/Colombo');
             ...
             if($page_titlecash == 'RMVLodge'){
                 //echo $getCDPUQCUserrmvlodgecash. "  -  ".$getCDPUQCHelpIDrmvlodgecash;
                   $sql_update = "UPDATE `rmv_header` 
                                     SET  `Extract_By`='".$getCDPUQCUserrmvlodgecash."',
                                          `Extract_on`=NOW() ,
                                          `Extract_Req` = 1
                                   WHERE `helpid` = '".$getCDPUQCHelpIDrmvlodgecash."';";
                    //echo $sql_update." -- ";
                    $query_update =  mysqli_query($conn,$sql_update) or die(mysqli_error($conn));
             }
...
<table border='1'>
    ...
    */
    ...
    function is_update_COD_FILE_PROCUSER($get_assuser,$get_aass_ksrl_helpid){
        //echo $get_assuser."--".$get_aass_ksrl_helpid."OK";
        $conn = DatabaseConnection();
        mysqli_autocommit($conn,FALSE);
        try{
            ...
            $sql_update_asing = "UPDATE `cdb_helpdesk` 
                                    SET `COD_FILE_PROCUSER`= '".$get_assuser."' ,
                                         `COD_FILE_PROCUSER_ON` = NOW()
