...
Page Name		: File Movement Details
Purpose			: To get File Movement Details
Author			: Madushan Wikramaarachchi
Date & Time		: 10.38 A.M 25/08/2014 (Modified)
                : 10.00 A.M 11/05/2016 Madushan Wickramaarachchi - Modified - Add new coloms in tabe for count of full riceve and parshaly ricive
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
	$_SESSION['page']="cou/q/001";
...
<title>File Movement Details</title>
...
<script type="text/javascript">
	...
	function filemovement(obj,title){
		if(obj == 'btnView'){ 
			...
			mydata1.open("GET","ajaxQuaryFilemomentSub.php"+"?txt2="+m,true);
			mydata1.send();
		}else{
