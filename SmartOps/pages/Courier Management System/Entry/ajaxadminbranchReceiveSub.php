<?php
	...
	$selectFile = "SELECT `fileName`,`createDateTime`,`branchNumber`,`departmentNumber`,`receiveDepartmentNumber`,`receiveBranchNumber`,`numberOfDocument`,`fileNumber` 
				   FROM `courier_files` 
				   WHERE `branchNumber`='$s' AND 
				         `receiveBranchNumber`='$p' AND 
						 (`stats`='AB' OR `stats`='OB') AND
						 `fileType` = '$t'";
