...
Page Name		: Courier Day Report
Purpose			: To Genarate Courier Day Report
Author			: Madushan Wikramaarachchi
Date & Time		: 02.17 P.M 25/08/2014 (Modified)
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
	$_SESSION['page']="cou/r/004";
...
<title>Courier Day Report</title>
...
<script type="text/javascript">
	function TypeSelect(){
		...
		mydata.open("GET","ajaxcouriarDayRepoart.php"+"?date1="+type1+"&bran="+type2+"&depar="+type3+"&date2="+type4,true);
		mydata.send();
	}
    function Typeprint(){
