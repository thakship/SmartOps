...
<!------------------------------------------------------------------------------------------------------------------------
Module Code		: Dep Ack
Page Name		: Certificate Acknowledgement
Purpose			: get report for Certificate Acknowledgement
...
<script type="text/javascript">
    ...
    function getGriedViwe(){
        ...
        if(fromDate == ""){
            ...
            mydata.open("GET","../DepAckno_DEVELOPMENT/PHP_FUNCTION/DepAckno_php_Ajax.php"+"?FrompritackDate="+fromDate+"&TopritackDate="+toDate,true);
            mydata.send();
        } 
    }
</script>
