...
//.........................................get Helpdesk ID for Service Requset List............................................................................
 ...
 if(isset($_REQUEST['getHelpIDreq1']) && isset($_REQUEST['gettxt_helpdesk_close1']) && isset($_REQUEST['get_moduleCode'])){
        getAjaxServiceRequsesList_helpIDSub($_REQUEST['getHelpIDreq1'],$_REQUEST['gettxt_helpdesk_close1'],$_REQUEST['get_moduleCode']);
        //echo $_REQUEST['getHelpIDreq1']."--".$_REQUEST['gettxt_helpdesk_close1'];
 }
 
  if(isset($_REQUEST['getHelpIDreq1Q3']) && isset($_REQUEST['gettxt_helpdesk_close1Q3']) && isset($_REQUEST['get_moduleCodeQ3'])){
        getAjaxServiceRequsesList_helpIDSubQ3($_REQUEST['getHelpIDreq1Q3'],$_REQUEST['gettxt_helpdesk_close1Q3'],$_REQUEST['get_moduleCodeQ3']);
        //echo $_REQUEST['getHelpIDreq1Q3']."--".$_REQUEST['gettxt_helpdesk_close1Q3'];
 }
 
  if(isset($_REQUEST['getHelpIDreqcdpu']) && isset($_REQUEST['gettxt_helpdesk_closeCDPU'])){
        //echo "cdpu";
        getAjaxServiceRequsesList_cREDITCARD_CDPU($_REQUEST['getHelpIDreqcdpu'],$_REQUEST['gettxt_helpdesk_closeCDPU']);
        //echo $_REQUEST['getHelpIDreq1']."--".$_REQUEST['gettxt_helpdesk_close1'];
 }
 
  if(isset($_REQUEST['getHelpIDreqCardCenterCC']) && isset($_REQUEST['gettxt_helpdesk_closeCardCenterCC'])){
      //  echo "card center";
        getAjaxServiceRequsesList_cREDITCARD_CardCenterCC($_REQUEST['getHelpIDreqCardCenterCC'],$_REQUEST['gettxt_helpdesk_closeCardCenterCC']);
        //echo $_REQUEST['getHelpIDreq1']."--".$_REQUEST['gettxt_helpdesk_close1'];
 }

  // 2019-01-28 Develop by madushan - Credit Card Initial Screening
if(isset($_REQUEST['getHelpIDreqCardCenterQ0']) && isset($_REQUEST['gettxt_helpdesk_closeCardCenterQ0'])){
      //echo "card center <br/>" ;
    //  echo $_REQUEST['getHelpIDreqCardCenterQ0'] ." -- ". $_REQUEST['gettxt_helpdesk_closeCardCenterQ0'];
    getAjaxServiceRequsesList_cREDITCARD_CardCenterQ0($_REQUEST['getHelpIDreqCardCenterQ0'],$_REQUEST['gettxt_helpdesk_closeCardCenterQ0']);
    //echo $_REQUEST['getHelpIDreq1']."--".$_REQUEST['gettxt_helpdesk_close1'];
}
 
   if(isset($_REQUEST['getHelpIDreqCardCenterCCDIS']) && isset($_REQUEST['gettxt_helpdesk_closeCardCenterCCDIS'])){
      //  echo "card center";
        getAjaxServiceRequsesList_cREDITCARD_CardCenterCC_Dispatch($_REQUEST['getHelpIDreqCardCenterCCDIS'],$_REQUEST['gettxt_helpdesk_closeCardCenterCCDIS']);
        //echo $_REQUEST['getHelpIDreq1']."--".$_REQUEST['gettxt_helpdesk_close1'];
 }
 
    if(isset($_POST['get_act_helpid']) && isset($_POST['get_act_user'])){
       //echo $_POST['get_act_helpid']." - ".$_POST['get_act_user'];
       creditCardActivetion($_POST['get_act_helpid'],$_POST['get_act_user']);
     //   getAjaxServiceRequsesList_cREDITCARD_CardCenterCC_Dispatch($_REQUEST['getHelpIDreqCardCenterCCDIS'],$_REQUEST['gettxt_helpdesk_closeCardCenterCCDIS']);
        //echo $_REQUEST['getHelpIDreq1']."--".$_REQUEST['gettxt_helpdesk_close1'];
 }
 ...
 if(isset($_REQUEST['getsubHelpIDreq'])){
  ...
  if(isset($_REQUEST['getsubHelpIDreqYes'])){
    //echo $_REQUEST['getsubHelpIDreqYes'];
    getAjaxServiceRequsesList_SoledIssueYes($_REQUEST['getsubHelpIDreqYes']); 
 }
 
 
 if(isset($_REQUEST['getsubHelpIDReject']) && isset($_REQUEST['get_moduleCode'])){
    //echo $_REQUEST['getsubHelpIDReject'];
    getAjaxServiceRequsesList_SoledReject($_REQUEST['getsubHelpIDReject'] , $_REQUEST['get_moduleCode']); 
 }
 ...
 if(isset($_REQUEST['getIss_templet']) && isset($_REQUEST['get_status']) && isset($_REQUEST['getcatCodeSelect'])){
  ...
  if(isset($_REQUEST['getHELPID_REPORT']) && isset($_REQUEST['geidNIC']) ){
    //echo $_REQUEST['get_cnic'];
    getDTLCreaditCard($_REQUEST['getHELPID_REPORT'],$_REQUEST['geidNIC']);
 } 
 //="+helpID+"&="+aIType
 
 
 function getDTLCreaditCard($HELPID,$NIC){
    //echo $HELPID."|".$NIC;
    $conn = DatabaseConnection();
    $sql_helpDesk_veri = "SELECT * FROM `cdb_helpdesk` 
                           WHERE `helpid` like '%".$HELPID."%' 
                             AND `issue` like '%".$NIC."%' AND `cat_code` = '1038'  ORDER BY `enterDateTime` DESC";
    $que_helpDesk_veri  = mysqli_query($conn , $sql_helpDesk_veri);
    $couhelpDesk_veri = mysqli_num_rows($que_helpDesk_veri);
    if($couhelpDesk_veri == 1){
        while($rec_helpDesk_veri = mysqli_fetch_assoc($que_helpDesk_veri)){
                ...
                $attachment_namesub = $rec_helpDesk_veri['attachment_namesub'];
                  
               echo $getHelpid."|".$getIssue."|".$getHelp_discr."|".$getattachment_name."|".$attachment_namesub;
        }
    }else{
		//echo "Multiple HelpIDs found....."	;
		while($rec_helpDesk_veri = mysqli_fetch_assoc($que_helpDesk_veri)){
			//$textout2 = " |" .$param2;
			echo $rec_helpDesk_veri['helpid'].",";
			//echo "Issue   : " . $rec_helpDesk_veri['issue'];
			//echo "------------------------------------------------------------" ;
		}
 ...
 //---------------------------------------------------------------------------------
 function creditCardActivetion($helpid,$user){
    $conn = DatabaseConnection();
    mysqli_autocommit($conn,FALSE);
    try{
        date_default_timezone_set('Asia/Colombo');
      
                $noteDis = 'Credit card Activate by'.$user;
                
                $sql_update = "UPDATE cdb_helpdesk AS a
                                SET a.COD_DO_PRINT_BY = '".$user."' ,
                                    a.COD_DO_PRINT_ON = NOW(),
                                    a.ssb_type = 'Credit card Activate'
                                WHERE a.helpid = '".$helpid."';";
               
                $query_update = mysqli_query($conn,$sql_update) or  die(mysql_error($conn));
                setNoteCreditCard($conn,$helpid,$noteDis,$user);
                
                noteTbl($conn, $helpid, $noteDis, $user);
                 // ----------------------------------------------------------------------------------------------------------------------//              
                if($query_update){
                    echo "OK";
                     mysqli_commit($conn); 
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------            
// Modified by Madushan on 9.22: AM 21/03/2018 -- Update the assigned user

        // Note Creation
if($rec_getHelpdesk['asing_by'] == ""){
        ...
        if($rec_select_note_count[1] == ""){
            //echo "c";
             $sql_note_update = "INSERT INTO `cdb_help_note`(`helpid`, `note_code`, `note_discr`, `enterBy`, `enterDateTime`,`NoteTag`) 
                        VALUES (".$gethelpID.",'".$cou."',CONCAT('Agent Assigned to Issue ', now()),'".$_SESSION['user']."',now(),'AGENT_ASSIGNED');";
            // echo $sql_note_update;
             $query_note_update = mysqli_query($conn,$sql_note_update) or die(mysqli_error($conn));
        }
       
    }  
   	$sql_update   = "update `cdb_helpdesk` 
                        set `cdb_helpdesk`.`asing_by` = '".$_SESSION['user']."' 
                      WHERE  trim(`cdb_helpdesk`.`asing_by`) = '' 
                        AND `cdb_helpdesk`.`helpid` = '".$gethelpID."';";
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function getAjaxServiceRequsesList_helpIDSub($gethelpID,$getStClose,$get_moduleCode){
        $conn = DatabaseConnection();
        echo $get_moduleCode;  
        ...
        $SQL_CheckBlankAssign = "SELECT `user`.`email`,`user`.`GSMNO`,`issue`,`ssb_facility_amount` 
                                   FROM `cdb_helpdesk`, `user` 
                                  WHERE `user`.`userName` = `cdb_helpdesk`.`enterBy` 
                                    AND `cat_code` = '1014' 
                                    and trim(`cdb_helpdesk`.`asing_by`) = '' 
                                    AND `cdb_helpdesk`.`helpid` = '".$gethelpID."';";
        ...
        while($rec_CheckBlankAssign = mysqli_fetch_array($RS_CheckBlankAssign)){
            ...
            //$query_sms =  mysqli_query($conn,$sql_sms) or die(mysqli_error($conn));                                                    
               ...
               echo "<fieldset style='width: 700px;margin-left: 100px;'>
                        <legend><label class='linetop'>Call Status :</label></legend> ";
                        echo "<input type='button' style='width: 200px;' class='buttonManage' value='Call Not Answered'  onclick='getSolutionCallNotans();'/>";
                        echo "<input type='button' style='width: 200px;' class='buttonManage' value='Call Answered'  onclick='getSolutionCallNotans1();'/>";
                        echo "<div id='callDiv'><div>";
                echo "</fieldset>";
               ...
               echo "<fieldset style='width: 700px;margin-left: 100px;'>
                        ...
                        echo "<table style='margin-left: 10px;'>";
                           ...
                           $sql_call_question = "SELECT cq.q_id , cq.q_dis
                                                    FROM call_question AS cq
                                                    WHERE cq.q_module_id = ".$get_moduleCode.";";
                           $query_call_question = mysqli_query($conn, $sql_call_question) or die(mysqli_error($conn));
                           $x = 1;
                           while($resal_call_question = mysqli_fetch_array($query_call_question)){
                                echo "<tr>
                                        <td>
                                            <label class='linetop'>".$resal_call_question[1]."</label>
                                            <input style='display: none;' type='text' name='txt_qid".$x."' id='txt_qid".$x."' value='".$resal_call_question[0]."' onKeyPress='return disableEnterKey(event)'/>
                                        <td>
                                        <td>
                                            <input class='box_decaretion' type='checkbox' name='chk_".$x."' id='chk_".$x."' onclick='isEnableBtnForRecoment()' onfocus='hilightColoyr(this.id)' onblur='colourLeave(this.id)'/>
                                        <td>
                                    </tr>";
                                $x++;
                           }
                        ...
                        echo "<div style='display: none;'>
                                 <input type='text' name='text_X' id='text_X' value='".$x."' />
                                 <input type='text' name='text_moduleCode' id='text_moduleCode' value='".$get_moduleCode."' />
                             </div>";
                        echo "<input type='button' style='width: 100px;' id='btnRecommend' class='buttonManage' disabled='disabled' value='Recommend' title='R' onclick='is_kiosk_ok(title,".$get_moduleCode.");'/>";
                        echo "<input type='button' style='width: 100px;' class='buttonManage' value='Reject' title='C' onclick='is_kiosk_ok(title,".$get_moduleCode.");'/>";
        ...
        while($rec_getHelpdesk = mysqli_fetch_assoc($v_que_getHelpdesk)){
            ...
            echo "<table>
                    <tr>
                        ...
                        <td style='width: 70px; text-align: right;'><label class='linetop'>Customer Category :</label></td>
                        <td>
                ...
                echo "<br/>
                       <table>
                        <tr>
                            ...
                            <td>
                                <select class='box_decaretion' name='txt_pn' id='txt_pn' onkeypress='return disableEnterKey(event)'>
                                     <option value=''>--Select Pending Notification--</option>
                                     <option value='Supportive docs not attached'> Supportive docs not attached </option>
									 ...
									 <option value='No Such person'> Unable to verify employment detail </option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <textarea class='box_decaretion' cols='47' rows='2' style='height:40px; width: 400px;' name='txt_pnndingNOTI' id='txt_pnndingNOTI' onkeypress='return disableEnterKey(event)'  onfocus='hilightColoyr(this.id)' onblur='colourLeave(this.id)'></textarea>
                            </td>
                        </tr>
                        <tr>
                             <td style='width: 140px; vertical-align: top;'></td>
                            <td>
                                <input type='button' style='width: 100px;' class='buttonManage' value='Notify Pending' title='2' onclick='is_kiosk_pending(title);'/>
                            </td>
                        </tr>
                    </table><br/><br/>";
...
//*******************************************************************************************************************************************    
     function getAjaxServiceRequsesList_helpIDSubQ3($gethelpID,$getStClose,$get_moduleCode){
        $conn = DatabaseConnection();
        //echo $get_moduleCode;
        ...
        while($rec_CheckBlankAssign = mysqli_fetch_array($RS_CheckBlankAssign)){
            ...
            //$query_sms =  mysqli_query($conn,$sql_sms) or die(mysqli_error($conn));                                                    
               ...
               echo "<fieldset style='width: 700px;margin-left: 100px;'>
                        <legend><label class='linetop'>Verification :</label></legend> ";
                        echo "<input type='button' style='width: 200px;' class='buttonManage' value='Call Status'  onclick='getSolutionCallNotans();'/>";
                        echo "<table style='margin-left: 10px;'>";
                        ...
                        echo "<input type='button' style='width: 100px;' id='btnRecommend' class='buttonManage' disabled='disabled' value='Recommend' title='R' onclick='is_kiosk_DIS(title,".$get_moduleCode.");'/>";
                        echo "<input type='button' style='width: 100px;' class='buttonManage' value='Reject' title='C' onclick='is_kiosk_DIS(title,".$get_moduleCode.");'/>";
                        ...
                        <tr style='width: 250px;'>
                            ...
                            <td>
                                <select class='box_decaretion' name='txt_pn' id='txt_pn' onkeypress='return disableEnterKey(event)'>
                                     ...
                                     <option value='Incorrect Number'> Incorrect Number </option>
                                     <option value='No Such person'> No Such person </option>
									 <option value='Unable to verify employment detail'> Unable to verify employment detail </option>
                                </select>
                                <input type='button' style='width: 100px;' class='buttonManage' value='Notify Pending' title='2' onclick='is_kiosk_pending(title);'/>
    ...
    function getAjaxServiceRequsesList_cREDITCARD_CDPU($gethelpID,$getStClose){
        $conn = DatabaseConnection();
			...
			if ($_SESSION['usergroupNumber'] == 'ug00094' || $_SESSION['usergroupNumber'] == 'ug00092'){
                ...
                while($rec_select_note_count = mysqli_fetch_array($query_select_note_count)){
                    ...
                    if($rec_select_note_count[1] == ""){
                        //echo "c";
                         $sql_note_update = "INSERT INTO `cdb_help_note`(`helpid`, `note_code`, `note_discr`, `enterBy`, `enterDateTime`,`NoteTag`) 
                                    VALUES (".$gethelpID.",'".$cou."',CONCAT('CDPU Assigned to Credit Card file ', now()),'".$_SESSION['user']."',now(),'AGENT_ASSIGNED');";
                        // echo $sql_note_update;
                         $query_note_update = mysqli_query($conn,$sql_note_update) or die(mysqli_error($conn));
                    }
        ...
        while($rec_getHelpdesk = mysqli_fetch_assoc($v_que_getHelpdesk)){
            ...
            $v_sql_getUsreNAme = "SELECT `email`,`GSMNO`,`kiosl_rec` FROM `user` WHERE `userName` =  '".$rec_getHelpdesk['enterBy']."';";
            $que_getUsreNAme = mysqli_query($conn,$v_sql_getUsreNAme);
            $E_user = cdb_ssb_eveluate_user($conn,$gethelpID);
            ...
            echo "<table>
             ...
             echo "<table>
                ...
                </table>"; // <input type='button' class='buttonManage' id='btnremove' name='btnremove' value='Remove' onclick='removeUsreID()'/>
                echo "<table>
                    <tr>
                        <td style='width: 100px; text-align: right;vertical-align: top;'><label class='linetop'>Note :</label></td>
                        <td>
                ...
                <table>
                    <tr>
                        ...
                        if($rec_getHelpdesk['facno'] == ''){
                         ...
                         //echo "<input type='button' style='width: 100px;' class='buttonManage' value='Approve' title='A' onclick='isEveluale(title);'/>";
                         //echo "<input type='button' style='width: 100px;' class='buttonManage' value='Reject' title='R' onclick='isEveluale(title);'/>";
                         echo "<input type='button' style='width: 100px;' class='buttonManage' value='Close' onclick='pageRef()'/>";
                         echo "<input type='button' style='width: 100px;' class='buttonManage' value='Reject' title='C' onclick='is_kiosk_ok11(title);'/>";
...
//--------------------------------------------- card Cenetr ajax load -----------------------------------
function getAjaxServiceRequsesList_cREDITCARD_CardCenterCC($gethelpID,$getStClose){
        $conn = DatabaseConnection();
        ...
        while($rec_getHelpdesk = mysqli_fetch_assoc($v_que_getHelpdesk)){
            ...
            echo "<table>
                    <tr>
                        ...
                        <td style='width: 70px; text-align: right;'><label class='linetop'>File Type :</label></td>
                        <td>
                            <input class='box_decaretion' type='text'  style='width:120px;' name='sel_scat021' id='sel_scat021' value='".$v_sel_scat02."' onKeyPress='return disableEnterKey(event)'  onfocus='hilightColoyr(this.id)' onblur='colourLeave(this.id)' readonly='readonly' />      
                            <input class='box_decaretion' type='text'  style='width:120px;' name='sel_scat02Code' id='sel_scat02Code' value='".$rec_getHelpdesk['scat_code_2']."' onKeyPress='return disableEnterKey(event)'  onfocus='hilightColoyr(this.id)' onblur='colourLeave(this.id)' readonly='readonly' />      
...
//--------------------------------------------- card Cenetr ajax load -----------------------------------
function getAjaxServiceRequsesList_cREDITCARD_CardCenterQ0($gethelpID,$getStClose){
    $conn = DatabaseConnection();
    ...
    while($rec_getHelpdesk = mysqli_fetch_assoc($v_que_getHelpdesk)){
       ...
       // }
        ...
        //echo "<input type='button' style='width: 100px;' class='buttonManage' value='Cancel' onclick=''/>";
        echo "<input type='button' style='width: 100px;' class='buttonManage' value='Back to BOIC' title='B' onclick='isEveluale(title);'/>";
        echo "<input type='button' style='width: 100px;' class='buttonManage' value='Approve' title='A' onclick='isEveluale(title);'/>";
        echo "<input type='button' style='width: 100px;' class='buttonManage' value='Reject' title='R' onclick='isEveluale(title);'/>";
        echo "<input type='button' style='width: 100px;' class='buttonManage' value='Close' onclick='pageRef()'/>";
...
//----------------------------------------------Card Centre Dispatch Ajax Load (13/11/2018) ----------------   
function getAjaxServiceRequsesList_cREDITCARD_CardCenterCC_Dispatch($gethelpID,$getStClose){
        $conn = DatabaseConnection();
...
//---------------------------------------------------------------------------------------------------------------------------
function cdb_ssb_eveluate_user($conn,$HelpID){
    $sql = "SELECT s.evaluate_assign_by 
                FROM cdb_ssb AS s 
                WHERE s.helpid = ".$HelpID.";";
    $qurery = mysqli_query($conn,$sql) or die(mysqli_error($conn));
    while($rec = mysqli_fetch_array($qurery)){
        return $rec[0];
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 function getAjaxServiceRequsesList_SoledIssueYes($getSubHI){
         $conn = DatabaseConnection();
      //  echo "A";
        $v_get_Issue = "SELECT `issue`,`enterBy`, `scat_code_2` , `scat_code_3`, `entry_branch` , `entry_department` 
                          FROM `cdb_helpdesk` WHERE `helpid` = '".$getSubHI."'";
        ...
        echo "<table>
                    ...
                    <table id='callFed' style='display: none;'>
                     <tr>  
                        ...
                        <td>
                           <select class='box_decaretion' name='selCallFeedback' id='selCallFeedback' onkeypress='return disableEnterKey(event)' onchange = 'getCallFSUBback();'>
                                     ...
                                     <option value='3'> Call Back Request </option>
                           </select>
                        </td>
                    </tr>
                    </table>
...
function getAjaxServiceRequsesList_SoledIssue($getSubHI){
 ...
 // ---------------------------- 2018-08-17 --- Madushan Reject Function --------------------------------------------  
function getAjaxServiceRequsesList_SoledReject($getSubHI,$get_moduleCode){
    
    //echo $getSubHI . " Test Reject<br/><br/>";
        $conn = DatabaseConnection();
      //  echo "A";
        $v_get_Issue = "SELECT `issue`,`enterBy`, `scat_code_2` , `scat_code_3`, `entry_branch` , `entry_department` 
                          FROM `cdb_helpdesk` WHERE `helpid` = '".$getSubHI."'";
        ...
        echo "<table>
                     ...
                     <td style='width: 100px; text-align: right; vertical-align: top;'><label class='linetop'>Call Feedback  :</label></td>
                        <td>
                            <select class='box_decaretion' name='selCallFeedbackNO' id='selCallFeedbackNO' onkeypress='return disableEnterKey(event)'>
                             <option value=''>--Select Call Feedback--</option>";
                             if($get_moduleCode=="1"){
                                echo "<option value='Customer not interested'> Customer not interested </option>
                                <option value='Verification Fail'> Verification Fail </option>
                                <option value='Invalid Data'> Invalid Data </option>";
                             }elseif($get_moduleCode=="2"){
                                echo "<option value='Verification Fail'> Verification Fail  </option>    
                                <option value='Guarantor Refuse'> Guarantor Refuse </option>";
                             }else{    
                                 echo "<option value='Customer not interested'> Customer not interested </option>
                                 <option value='Invalid Data'> Invalid Data </option>
                                 <option value='Verification Fail'> Verification Fail </option>
                                 <option value='Guarantor Refuse'> Guarantor Refuse </option>
                                 <option value='Verification Fail'> Verification Fail  </option>
                                 <option value='Income Mismatch'> Income Mismatch </option>
                                 <option value='Not Employed'> Not Employed </option>
                                 <option value='Designation mismatch'> Designation mismatch </option>
                                 <option value='Dispute with length of service'> Dispute with length of service </option>
                                 <option value='Employer uncontestable'> Employer uncontestable </option>
                                 <option value='Unsatisfactory CRIB'> Unsatisfactory CRIB </option>
                                 <option value='Customer refuse the credit limit'> Customer refuse the credit limit </option>";
                             }
                           echo "</select>
                        </td>
                    </tr>
                    ...
                    <tr>
                     ...
                     echo "<tr>
                        <td style='width: 100px;'>&nbsp;</td>
                        <td>
                            <input type='submit' style='width: 100px;' class='buttonManage' id='btnReqReject' name='btnReqReject' value='Submit'/>";
