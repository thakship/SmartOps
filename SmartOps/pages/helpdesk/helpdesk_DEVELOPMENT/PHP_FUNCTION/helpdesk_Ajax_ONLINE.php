...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function getAjaxServiceRequsesList_helpIDSub($gethelpID,$getStClose){
        ...
        $SQL_CheckBlankAssign = "SELECT `user`.`email`,`user`.`GSMNO`,`issue`,`ssb_facility_amount` FROM `cdb_helpdesk`,`user` WHERE `user`.`userName` = `cdb_helpdesk`.`enterBy` AND `cat_code` = '1032' and trim(`cdb_helpdesk`.`asing_by`) = '' AND `cdb_helpdesk`.`helpid` = '".$gethelpID."';";
        ...
        while($rec_CheckBlankAssign = mysqli_fetch_array($RS_CheckBlankAssign)){
			...
			if ($_SESSION['usergroupNumber'] == 'ug00094' || $_SESSION['usergroupNumber'] == 'ug00092'){
                ...
                while($rec_select_note_count = mysqli_fetch_array($query_select_note_count)){
               	...
               	$sql_update   = "update `cdb_helpdesk` set `cdb_helpdesk`.`asing_by` = '".$_SESSION['user']."' WHERE `cat_code` = '1032' and trim(`cdb_helpdesk`.`asing_by`) = '' AND `cdb_helpdesk`.`helpid` = '".$gethelpID."';";
        ...
        while($rec_getHelpdesk = mysqli_fetch_assoc($v_que_getHelpdesk)){
            ...
            $v_getRnterUsre = getUserName($rec_getHelpdesk['enterBy'],$conn); // Get Enter Usre Name
            $vAsingUser = getUserName($rec_getHelpdesk['asing_by'],$conn); // Get Assign Usre Name
            $vSSB_Moble = getSSBMoble($rec_getHelpdesk['helpid'],$conn); // Get SSB Moblie Number
            $vSSB_Name = getSSBName($rec_getHelpdesk['helpid'],$conn); // Get SSB Client Name
            ...
            echo "<table>
                    <tr>
                        <td style='width: 100px; text-align: right;'><label class='linetop'>Cilent Email :</label></td>
                        <td>
                    ...
                    <tr>
                        <td style='width: 100px; text-align: right; vertical-align: top;'><label class='linetop'>Client Mobile :</label></td>
                        <td>
                            <input class='box_decaretion' type='text'  style='width:200px;' name='txt_issuessb_facility_amount' id='txt_issuessb_facility_amount' value='".$vSSB_Moble."' onKeyPress='return disableEnterKey(event)'  onfocus='hilightColoyr(this.id)' onblur='colourLeave(this.id)' readonly='readonly'/>
                        </td>
                    </tr>
                     <tr>
                        <td style='width: 100px; text-align: right; vertical-align: top;'><label class='linetop'>Client Name :</label></td>
                        <td>
                            <input class='box_decaretion' type='text'  style='width:200px;' name='txt_Client_Name' id='txt_Client_Name' value='".$vSSB_Name."' onKeyPress='return disableEnterKey(event)'  onfocus='hilightColoyr(this.id)' onblur='colourLeave(this.id)' readonly='readonly'/>
                        </td>
                    </tr>
                ...
                <fieldset style='width: 700px;margin-left: 100px;'>
                    ...
                    echo "<table>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td style='width: 150px;'>
                                 <span class='linetop' style='width: 100px;'>Postal Code :</span> 
                            </td>
                            <td style='width: 200px;'>     
                    ...
                    <table>
                    <tr  style='width: 250px;'>
                        <td style='width: 140px;'><label class='linetop'>Account Number :</label></td>
                        <td>";
                        ...
                        if( $rec_getHelpdesk['ssb_app_number'] == 0 ||  $rec_getHelpdesk['ssb_app_number'] == ""){
                            if ($rec_getHelpdesk['scat_code_2'] == '10320101' || $rec_getHelpdesk['scat_code_2'] == '10320101' || $rec_getHelpdesk['scat_code_2'] == '10320101')
                                echo "<input class='box_decaretion' type='text' style='width:180px;margin-left: 5px;font-size:15px;' name='txt_app_number' id='txt_app_number' maxlength='18' value='' onKeyPress='return disableEnterKey(event)'  placeholder='Account No' />";
                            else
                                echo "<input class='box_decaretion' type='text' style='width:180px;margin-left: 5px;font-size:15px;' name='txt_app_number' id='txt_app_number' maxlength='18' value='' onKeyPress='return disableEnterKey(event)'  placeholder='Account No' />";
                        }else{
                            if ($rec_getHelpdesk['scat_code_2'] == '10320101' || $rec_getHelpdesk['scat_code_2'] == '10320101' || $rec_getHelpdesk['scat_code_2'] == '10320101')
                                echo "<input class='box_decaretion'  type='text' style='width:180px;margin-left: 5px;font-size:15px;' name='txt_app_number' id='txt_app_number' maxlength='18' value='". $rec_getHelpdesk['ssb_app_number']."' onKeyPress='return disableEnterKey(event)'  placeholder='Account No' ".$readonli_btn." />";
                      ...
                      //  if( $rec_getHelpdesk['IsAppValid'] != '1' ){
                            ...
                            if ($rec_getHelpdesk['scat_code_2'] == '10320101' || $rec_getHelpdesk['scat_code_2'] == '10320101' || $rec_getHelpdesk['scat_code_2'] == '10320101')
                                echo "<input type='button' style='width: 120px' class='buttonManage' value='Acc Confirmation'  title='CDB' onclick='isAppGenerater(title);' ".$dis_btn." />";
                            else
                                echo "<input type='button' style='width: 120px' class='buttonManage' value='Acc Confirmation'  title='CDB' onclick='isAppGenerater(title);' ".$dis_btn."/>";
                ...
                <table>
                    <tr>
                        ...
                        if($rec_getHelpdesk['facno'] == ''){
                             if($rec_getHelpdesk['facno'] == '' && $rec_getHelpdesk['ssb_app_number'] != '' ){
                                echo "<input type='button' style='width: 100px;' class='buttonManage' value='CDBiNet Create' title='1' onclick='is_kiosk_ok(title);'/>";
...
function getSSBMoble($helpid,$conn){
    $sql = "select s.C_Moble from cdb_ssb AS s where s.helpid = '".$helpid."';";
...
function getSSBName($helpid,$conn){
    $sql = "select s.C_Client_name from cdb_ssb AS s where s.helpid = '".$helpid."';";
    $query = mysqli_query($conn,$sql);
    while($rec = mysqli_fetch_array($query)){
        return $rec[0];
    }
                    ...
                    <tr  style='width: 250px;'>
                        ...
                        if( $rec_getHelpdesk['ssb_app_number'] == 0 ||  $rec_getHelpdesk['ssb_app_number'] == ""){
                            if ($rec_getHelpdesk['scat_code_2'] == '10140108' || $rec_getHelpdesk['scat_code_2'] == '10140109' || $rec_getHelpdesk['scat_code_2'] == '10140110' || $rec_getHelpdesk['scat_code_2'] == '10140130')
                                ...
                                echo "<input class='box_decaretion' type='text' style='width:180px;margin-left: 5px;font-size:15px;' name='txt_app_number' id='txt_app_number' maxlength='18' value='' onKeyPress='return disableEnterKey(event)'  placeholder='Account Number' />";
                        }else{
                            if ($rec_getHelpdesk['scat_code_2'] == '10140108' || $rec_getHelpdesk['scat_code_2'] == '10140109' || $rec_getHelpdesk['scat_code_2'] == '10140110' || $rec_getHelpdesk['scat_code_2'] == '10140130')
                                ...
                                echo "<input class='box_decaretion' type='text' style='width:180px;margin-left: 5px;font-size:15px;' name='txt_app_number' id='txt_app_number' maxlength='18' value='". $rec_getHelpdesk['ssb_app_number']."' onKeyPress='return disableEnterKey(event)'  placeholder='Account Number' ".$readonli_btn." />";
                                // ". ($rec_getHelpdesk['IsAppValid'] == '1'?"disabled='disabled'":"") ."
                        }   
              ...
              if($REC_getHelpdesk_edit['cat_code'] == '1014'){
                ...
                echo "</td>
                    ...
                    <tr>
                     ...
                     if($REC_getHelpdesk_edit['cat_code'] == '1032'){
                   echo "<tr>
                        <td style='width: 100px; text-align: right;'><label class='linetop'>Main File :</label></td>
                        <td>";
