...
//.........................................get Helpdesk ID for Service Requset List............................................................................
 ...
 if(isset($_REQUEST['getHelpIDreq1']) && isset($_REQUEST['gettxt_helpdesk_close1'])){
  ...
  if(isset($_REQUEST['getHelpIDreq1los']) && isset($_REQUEST['gettxt_helpdesk_close1los'])){
        getAjaxServiceRequsesList_helpIDSubLOS($_REQUEST['getHelpIDreq1los'],$_REQUEST['gettxt_helpdesk_close1los']);
        //echo $_REQUEST['getHelpIDreq1']."--".$_REQUEST['gettxt_helpdesk_close1'];
 }
 
 if(isset($_REQUEST['getHelpIDreq1f8']) && isset($_REQUEST['gettxt_helpdesk_close1f8'])){
        getAjaxServiceRequsesList_helpIDF8gen($_REQUEST['getHelpIDreq1f8'],$_REQUEST['gettxt_helpdesk_close1f8']);
        //echo $_REQUEST['getHelpIDreq1']."--".$_REQUEST['gettxt_helpdesk_close1'];
 }
 
  if(isset($_REQUEST['getHelpIDreqEVL']) && isset($_REQUEST['gettxt_helpdesk_closeEVL'])){
        echo "EVL";
        getAjaxServiceRequsesList_helpIDEVL($_REQUEST['getHelpIDreqEVL'],$_REQUEST['gettxt_helpdesk_closeEVL']);
        //echo $_REQUEST['getHelpIDreq1']."--".$_REQUEST['gettxt_helpdesk_close1'];
 }
 ...
 if(isset($_REQUEST['get_cnic']) && isset($_REQUEST['getscat2'])&& isset($_REQUEST['getscat3']) ){
    //echo $_REQUEST['getscat3'];
    getNewCompliedDataGrid_informetion($_REQUEST['get_cnic'],$_REQUEST['getscat2'],$_REQUEST['getscat3']);
 } 
...
Inquiry :
                                ...
                                ";
         }else if($getcatCodeSelect == "1024" && $scat1 == "102405"){
   
             echo "<tr>
                        <td style='width: 100px; text-align: right;'><label class='linetop'>Clint Code :</label></td>
                        <td>
...
Email :
Mobile Number :
Client Type : Only Individual
Visited Branch : 
Clint segment updated : Yes/NO
Cilnt registed with i-net : Yes/No
</textarea>
                        </td>
                      </tr>
                        ";
        ...
        while($rec_getHelpdesk = mysqli_fetch_assoc($v_que_getHelpdesk)){
            ...
            echo "<table>
                    <tr>
                        ...
                        <td style='width: 100px; text-align: right;'><label class='linetop'>File Type 1:</label></td>
                        <td>
                         ...
                         <td style='width: 100px; text-align: right;'><label class='linetop'>File Type 2:</label></td>
                        <td>
                ...
                <fieldset style='width: 700px;margin-left: 100px;'>
                    ...
                    echo "<table>
                        <tr>
                            ...
                            <td tyle='width: 150px;'>
                                <label class='linetop'>Guarantor 1 :</label> 
                            </td>
                            <td tyle='width: 200px;'>
                                <input class='box_decaretion' type='text' style='width:100px;' name='txt_Granter_1_ssb' id='txt_Granter_1_ssb' maxlength='8' value='".$gar_code_1."' onKeyPress='return isNumber(event)'  placeholder='Guarantor 1' />
                        ...
                        <tr>
                            ...
                            <td style='width: 150px;'>     
                             ...
                             <td tyle='width: 150px;'>
                                <label class='linetop'>Guarantor 2 :</label> 
                            </td>
                            <td tyle='width: 200px;'>
                                <input class='box_decaretion' type='text' style='width:100px;' name='txt_Granter_2_ssb' id='txt_Granter_2_ssb' maxlength='8' value='".$gar_code_2."' onKeyPress='return isNumber(event)'  placeholder='Guarantor 2' />
                        ...
                        <tr>
                            ...
                            <td style='width: 200px;'>     
                             ...
                             <td tyle='width: 150px;'>
                                <label class='linetop'>Co-Applicant :</label> 
                            </td>
                            <td tyle='width: 200px;'>
                                <input class='box_decaretion' type='text' style='width:100px;' name='txt_Granter_3_ssb' id='txt_Granter_3_ssb' maxlength='8' value='".$gar_code_3."' onKeyPress='return isNumber(event)'  placeholder='Co-Applicant' />
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function getAjaxServiceRequsesList_helpIDSubLOS($gethelpID,$getStClose){
        $conn = DatabaseConnection();
        ...
        // Modified by Rizvi Kareem on 1:29 PM 10/03/2016   -- Note creation and SMS sending to MTK Officer
			...
			if ($_SESSION['usergroupNumber'] == 'ug00094' || $_SESSION['usergroupNumber'] == 'ug00092' ){
                ...
                //$sql_select_note_count =  "SELECT COUNT(*) FROM `cdb_help_note` WHERE `helpid` = '".$gethelpID."';";
                echo "U";
                $sql_ssb_count = "SELECT COUNT(*) FROM cdb_ssb AS s  WHERE s.helpid = ".$gethelpID." AND s.los_assing_by IS NULL;";
                
                $query_ssb_count = mysqli_query($conn,$sql_ssb_count) or die(mysqli_error($conn));
                while($rec_ssb_count = mysqli_fetch_array($query_ssb_count)){
                    if($rec_ssb_count[0] == 1){
                        // Note Creation
                        //$sql_select_note_count =  "SELECT COUNT(*) FROM `cdb_help_note` WHERE `helpid` = '".$gethelpID."';";
                        $sql_select_note_count = "SELECT COUNT(c.helpid)
                                                    FROM cdb_help_note AS c
                                                   WHERE c.helpid = '".$gethelpID."';";
                        $query_select_note_count = mysqli_query($conn , $sql_select_note_count) or die(mysqli_error($conn));
                        $cou = 1;
                        //echo "A";
                        while($rec_select_note_count = mysqli_fetch_array($query_select_note_count)){
                            ...
                            //echo "c";
                            $sql_note_update = "INSERT INTO `cdb_help_note`(`helpid`, `note_code`, `note_discr`, `enterBy`, `enterDateTime`,`NoteTag`) 
                                                    VALUES (".$gethelpID.",'".$cou."',CONCAT('LOS - Agent Assigned to file ', now()),'".$_SESSION['user']."',now(),'EVALUATE_AGENT_ASSIGNED');";
                                // echo $sql_note_update;
                            $query_note_update = mysqli_query($conn,$sql_note_update) or die(mysqli_error($conn));
                        }  
                        
                       	$sql_update   = "UPDATE `cdb_ssb` 
                                            SET `cdb_ssb`.`los_assing_by` = '".$_SESSION['user']."' ,
                                                `cdb_ssb`.los_assing_on = NOW()
                                          WHERE `cdb_ssb`.`los_assing_by` IS NULL
                                            AND `cdb_ssb`.`helpid` = '".$gethelpID."';";
                        //echo $sql_update;
        				$query_update =  mysqli_query($conn,$sql_update) or die(mysqli_error($conn));
                    }
                } 
        ...
        while($rec_getHelpdesk = mysqli_fetch_assoc($v_que_getHelpdesk)){
            ...
            $E_user = cdb_ssb_CDPU_user($conn,$gethelpID);
            ...
            echo "<table>
             ...
             echo "<table>
                    ...
                    echo "<tr>
                        <td style='width: 100px; text-align: right;'><label class='linetop'>Assign User :</label></td>
                        <td>
                                <input class='box_decaretion' type='text' style='width:100px; color: #747474; background: #F2F2F2;' name='txt_inner_User1' id='txt_inner_User1' value='".$E_user."' onKeyPress='return disableEnterKey(event)' readonly='readonly' placeholder='User ID' onclick='popup(1);'/> 
                                <input class='box_decaretion' type='text' style='width:400px; color: #747474; background: #F2F2F2;' name='txt_inner_User2' id='txt_inner_User2' value='".getUserName($E_user,$conn)."' onKeyPress='return disableEnterKey(event)' readonly='readonly' placeholder='User Name' onclick='popup(1);'/>
                                <input type='button' class='buttonManage' id='btnPopUp' name='btnPopUp' value='...' onclick='popup(1);'/> 
                                <input type='button' class='buttonManage' id='btnremove' name='btnremove' value='Remove' onclick='removeUsreID()'/>
                                <input type='button' class='buttonManage' id='btnupdateUser' name='btnupdateUser' value='Update' onclick='updateAssUser()'/>
                        </td>
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function getAjaxServiceRequsesList_helpIDF8gen($gethelpID,$getStClose){
        $conn = DatabaseConnection();
                ...
                <table>
                    <tr>
                        ...
                        if($rec_getHelpdesk['facno'] == ''){
                         ...
                         echo "<input type='button' style='width: 100px;' class='buttonManage' title='A' value='Approve' onclick='isEveluale(title)'/>";
                        // echo "<input type='button' style='width: 100px;' class='buttonManage' title='R' value='Reject' onclick='isEveluale(title)'/>";
                         echo "<input type='button' style='width: 100px;' class='buttonManage' value='Close' onclick='pageRef()'/>";
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function getAjaxServiceRequsesList_helpIDEVL($gethelpID,$getStClose){
        $conn = DatabaseConnection();
        
        echo "N";
        // Modified by Rizvi on 9:51 AM 15/09/2015          -- Update the assigned user
        // Modified by Rizvi Kareem on 1:29 PM 10/03/2016   -- Note creation and SMS sending to MTK Officer
        $SQL_CheckBlankAssign = "SELECT `user`.`email`,`user`.`GSMNO`,`cdb_helpdesk`.`issue`,`cdb_helpdesk`.`ssb_facility_amount` 
                                   FROM `cdb_helpdesk`,`user` 
                                  WHERE `user`.`userName` = `cdb_helpdesk`.`enterBy` 
                                    AND `cdb_helpdesk`.`cat_code` = '1014' 
                                    AND `cdb_helpdesk`.`helpid` = '".$gethelpID."';";
        // echo $SQL_CheckBlankAssign;
        $RS_CheckBlankAssign = mysqli_query($conn,$SQL_CheckBlankAssign);
        while($rec_CheckBlankAssign = mysqli_fetch_array($RS_CheckBlankAssign)){
            /* Update the Assigned user*/
			if ($_SESSION['usergroupNumber'] == 'ug00001'){
			
                echo "U";
                $sql_ssb_count = "SELECT COUNT(*) FROM cdb_ssb AS s  WHERE s.helpid = ".$gethelpID." AND s.evaluate_assign_by IS NULL;";
                ...
                while($rec_ssb_count = mysqli_fetch_array($query_ssb_count)){
                    if($rec_ssb_count[0] == 1){
                        ...
                        while($rec_select_note_count = mysqli_fetch_array($query_select_note_count)){
                            ...
                            //echo "c";
                            $sql_note_update = "INSERT INTO `cdb_help_note`(`helpid`, `note_code`, `note_discr`, `enterBy`, `enterDateTime`,`NoteTag`) 
                                                    VALUES (".$gethelpID.",'".$cou."',CONCAT('Evaluate Agent Assigned to file ', now()),'".$_SESSION['user']."',now(),'EVALUATE_AGENT_ASSIGNED');";
                                // echo $sql_note_update;
                            $query_note_update = mysqli_query($conn,$sql_note_update) or die(mysqli_error($conn));
                        }  
                        
                       	$sql_update   = "UPDATE `cdb_ssb` 
                                            SET `cdb_ssb`.`evaluate_assign_by` = '".$_SESSION['user']."' ,
                                                `cdb_ssb`.evaluate_assign_on = NOW()
                                          WHERE `cdb_ssb`.`evaluate_assign_by` IS NULL
                                            AND `cdb_ssb`.`helpid` = '".$gethelpID."';";
                        //echo $sql_update;
        				$query_update =  mysqli_query($conn,$sql_update) or die(mysqli_error($conn));
                    }
...
function cdb_ssb_CDPU_user($conn,$HelpID){
    $sql = "SELECT s.los_assing_by 
                FROM cdb_ssb AS s 
                WHERE s.helpid = ".$HelpID.";";
    $qurery = mysqli_query($conn,$sql) or die(mysqli_error($conn));
    while($rec = mysqli_fetch_array($qurery)){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function getAjaxServiceRequsesList_SoledIssue($getSubHI){
        ...
        while($RES_get_Issue = mysqli_fetch_assoc($que_get_Issue)){
            ...
            //------------- Madushan 2018-07-16 ----- Scat 02 get Solution discreption ------------
            $solution_dis = "";
            $sql_scat_2_dis = "SELECT e.solutionDis FROM scat_02 AS e WHERE e.scat_code_2 = '".$RES_get_Issue['scat_code_2']."' AND e.isSolution = 1;";
            $query_scat_2_dis = mysqli_query($conn,$sql_scat_2_dis) or die(mysqli_error($conn));
            while($rec_scat_2_dis = mysqli_fetch_array($query_scat_2_dis)){
               $solution_dis = $rec_scat_2_dis[0];
            }
        ...
        echo "<table>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea class='box_decaretion' cols='47' rows='4' style='height:100px; width: 400px;' name='txtarea_Solution' id='txtarea_Solution' onKeyPress='return disableEnterKey(event)'  onfocus='hilightColoyr(this.id)' onblur='colourLeave(this.id)' >".$solution_dis."</textarea>
                        </td>
                    </tr>";
                        ...
                        echo " <tr>
                                ...
                                $cou_arr_length = sizeof($arr_dis);
                                 echo "
                                    ...
                                    //echo "<option value=''>--Select Decision --</option>";    
        ...
        while($REC_getHelpdesk_edit = mysqli_fetch_assoc($v_que_getHelpdesk_edit)){
         ...
         echo "<table>
            ...
            $v_getRnterUsre = getUserName($REC_getHelpdesk_edit['enterBy'],$conn); // Get Enter Usre Name
             ...
             echo "<table>";
              if($REC_getHelpdesk_edit['cat_code'] == '1014' || $REC_getHelpdesk_edit['cat_code'] == '1038'){
                   echo " <tr>
       ...
       //echo $getsel_catCode;
        $conn = DatabaseConnection();
                ...
                $v_sql_det_detels = "SELECT `cdb_helpdesk`.`helpid` , 
                                            ...
                                            `cmb_states`.`cmb_discr`, 
                                            `cdb_helpdesk`.`asing_by`, 
                                            `cdb_helpdesk`.`solved_by`, 
                                            `cdb_helpdesk`.`solved_on`,  
                                            `cdb_helpdesk`.`act_by`,  
                                            `cdb_helpdesk`.`act_on` , 
                                            `cdb_helpdesk`.`decision_discription`, 
                                            `scat_02`.`scat_discr_2` , 
                                            `cdb_helpdesk`.`scat_code_3` ,
              ...
              if($getsel_States != ""){
                ...
                $v_sql_det_detels .= "ORDER BY `cdb_helpdesk`.`enterDateTime` DESC;";
                    ...
                    $v_sql_det_detels = "SELECT `cdb_helpdesk`.`helpid` , DATE(`cdb_helpdesk`.`enterDateTime`), `cdb_helpdesk`.`issue`, `branch`.`branchName`, `deparment`.`deparmentName`, `cdb_helpdesk`.`enterBy`, `urgency_states`.`ur_discr`, `priority_states`.`pr_discr` ,`cmb_states`.`cmb_discr`, `cdb_helpdesk`.`asing_by`, `cdb_helpdesk`.`solved_by`, DATE(`cdb_helpdesk`.`solved_on`),  `cdb_helpdesk`.`act_by`,  DATE(`cdb_helpdesk`.`act_on`) , `cdb_helpdesk`.`decision_discription`, `scat_02`.`scat_discr_2` , `cdb_helpdesk`.`scat_code_3` , `cdb_helpdesk`.`scat_code_1`
                ...
                while($rec_det_detels = mysqli_fetch_array($v_que_det_detels)){
                    ...
                    echo "<td style='width:80px;text-align: right;".$colTR."' title = '".$asingBy."'><span style='margin-right: 2px;'>";
                    
                     if($rec_det_detels[17] == '102401'){
                        $ScatMKR = getUserName($rec_det_detels[16],$conn);
                        echo $rec_det_detels[16]. " - ".$ScatMKR;
                    }else{
                        echo $rec_det_detels[9];
                    }
                    echo "</span></td>";
...
function getNewCompliedDataGrid_informetion($get_cnic,$getscat2,$getscat3){
    //echo $getscat3;
    $conn = DatabaseConnection();
  ...
  $v_sql_det_detels = "SELECT `cdb_helpdesk`.`helpid` , DATE(`cdb_helpdesk`.`enterDateTime`), `cdb_helpdesk`.`issue`,`cdb_helpdesk`.`scat_code_2`, `branch`.`branchName`, `deparment`.`deparmentName`, `cdb_helpdesk`.`enterBy`, `urgency_states`.`ur_discr`, `priority_states`.`pr_discr` , `cdb_helpdesk`.`asing_by` , `cdb_helpdesk`.`cat_code` , `cdb_helpdesk`.`ssb_facility_amount` , `cdb_helpdesk`.`ssb_type`,`cdb_helpdesk`.`help_discr`,IF(`cdb_helpdesk`.`ssb_app_number` = '', 4, `cdb_helpdesk`.`IsAppValid`) as validapp,`cdb_helpdesk`.`ssb_app_number`,`cdb_helpdesk`.`facno`,`cdb_helpdesk`.`caloser_dateTime`,DATE(`cdb_helpdesk`.`caloser_dateTime`) = DATE(NOW()) AS is_old,
     ...
     WHERE `cdb_helpdesk`.`ur_code` = `urgency_states`.`ur_code` AND
           ...
           `cdb_helpdesk`.`cmb_code` = '5002'";
if($get_cnic != ""){
     $v_sql_det_detels .= " AND `cdb_helpdesk`.`issue` like  '%".$get_cnic."%'";
}
if($getscat2 != ""){
    $v_sql_det_detels .= "AND `cdb_helpdesk`.`scat_code_2` like '%".$getscat2."%'";
    
}
if($getscat3 != ""){
    $v_sql_det_detels .= "AND `cdb_helpdesk`.`scat_code_3` like '%".$getscat3."%'";
}

$v_sql_det_detels .= "ORDER BY (`cdb_helpdesk`.`caloser_dateTime`) DESC;"; //enterDateTime       
    ...
    while($rec_det_detels = mysqli_fetch_array($v_que_det_detels)){
       $sql_count_note = "SELECT COUNT(*) FROM `cdb_help_note` WHERE `helpid` = '".$rec_det_detels[0]."';";
        ...
        echo "<td style='width:100px;text-align: left;".$MyRow ."'><span style='margin-left: 2px;'>".scat02gen($conn,$rec_det_detels[3])." - ".$rec_det_detels[19]."</span></td>";
