...
session_start();  
    ...
    //------------------- 2018-04-23 Madushan - Eveluate------------------------
     
    if(isset($_POST['get_EVL_helpid']) && isset($_POST['get_EVL_user']) && isset($_POST['get_title'])){
        //echo $_POST['get_UCL_appNUmber']."--".$_POST['get_EVL_user']."--".$_POST['get_UCL_app_ksrl_user']." OK";
       isKioslFileEveluate($_POST['get_EVL_helpid'],$_POST['get_EVL_user'],$_POST['get_title']);
       
    }
    
     if(isset($_POST['get_F8_helpid']) && isset($_POST['get_F8_user']) && isset($_POST['get_F8title'])){
        //echo $_POST['get_UCL_appNUmber']."--".$_POST['get_EVL_user']."--".$_POST['get_UCL_app_ksrl_user']." OK";
       isKioslFileEveluateF8($_POST['get_F8_helpid'],$_POST['get_F8_user'],$_POST['get_F8title']);
    ...
    if(isset($_POST['get_assuser']) &&  isset($_POST['get_aass_ksrl_helpid'])){
        is_update_assing_user(trim($_POST['get_assuser']),trim($_POST['get_aass_ksrl_helpid']));
   
    }
    
     if(isset($_POST['get_assuserlos']) &&  isset($_POST['get_aass_ksrl_helpidlos'])){
        is_update_assing_userlos(trim($_POST['get_assuserlos']),trim($_POST['get_aass_ksrl_helpidlos']));
   
    }
    
    if(isset($_POST['get_EVLassuser']) &&  isset($_POST['get_EVLaass_ksrl_helpid'])){
        is_update_assing_EVLuser(trim($_POST['get_EVLassuser']),trim($_POST['get_EVLaass_ksrl_helpid']));
...
<table border='1'>
    ...
    function is_update_assing_user($get_assuser,$get_aass_ksrl_helpid){
     ...
     function is_update_assing_userlos($get_assuser,$get_aass_ksrl_helpid){
        //echo $get_assuser."--".$get_aass_ksrl_helpid."OK";
        $conn = DatabaseConnection();
        mysqli_autocommit($conn,FALSE);
        try{
            // Validation rule engine
            $sql_update_asing = "UPDATE `cdb_ssb` 
                                    SET `los_assing_by`= '".$get_assuser."'
    ...
    function is_update_assing_EVLuser($get_assuser,$get_aass_ksrl_helpid){
        //echo $get_assuser."--".$get_aass_ksrl_helpid."OK";
        $conn = DatabaseConnection();
        mysqli_autocommit($conn,FALSE);
        try{
            ...
            $inset_ssb_his = "INSERT INTO cdb_ssb_his ( `helpid` ,`applicant_info` ,`clear_valuation`,`guarantor_1` ,`guarantor_2` ,`cr_copy_and_invoce`, `supplar_info` ,`pending_notification`,`histdate` ,`enuser`,`P_V`,`clcode`,`clcode_on`,`clcode_by`,`clcode_val`,`supcode`,`supcode_on`,`supcode_by`,`supcode_val`,`gar_code_1` ,`gar_code_1_on`,`gar_code_1_by`,`gar_code_1_val`,`gar_code_2` ,`gar_code_2_on` ,`gar_code_2_by` ,`gar_code_2_val` ,`gar_code_3` ,`gar_code_3_on` ,`gar_code_3_by` ,`gar_code_3_val`,`sec_no` ,`sec_no_on`,`sec_no_by` ,`sec_no_val` ,`supacc` ,`supacc_on` ,`supacc_by` ,`supacc_val` ,`recacc` ,`recacc_on` ,`recacc_by` ,`recacc_val` ,`C_Moble` ,`C_Client_name` ,`source_code` ,`source_code_by` ,`source_code_on` ,`file_evaluate` ,`file_evaluate_by`,`file_evaluate_on` , `evaluate_assign_by`, `evaluate_assign_on` )
                                               SELECT `helpid` ,`applicant_info` ,`clear_valuation`,`guarantor_1` ,`guarantor_2` ,`cr_copy_and_invoce`, `supplar_info` ,`pending_notification`,`histdate` ,`enuser`,`P_V`,`clcode`,`clcode_on`,`clcode_by`,`clcode_val`,`supcode`,`supcode_on`,`supcode_by`,`supcode_val`,`gar_code_1` ,`gar_code_1_on`,`gar_code_1_by`,`gar_code_1_val`,`gar_code_2` ,`gar_code_2_on` ,`gar_code_2_by` ,`gar_code_2_val` ,`gar_code_3` ,`gar_code_3_on` ,`gar_code_3_by` ,`gar_code_3_val`,`sec_no` ,`sec_no_on`,`sec_no_by` ,`sec_no_val` ,`supacc` ,`supacc_on` ,`supacc_by` ,`supacc_val` ,`recacc` ,`recacc_on` ,`recacc_by` ,`recacc_val` ,`C_Moble` ,`C_Client_name` ,`source_code` ,`source_code_by` ,`source_code_on` ,`file_evaluate` ,`file_evaluate_by`,`file_evaluate_on` , `evaluate_assign_by`, `evaluate_assign_on`
                                                FROM cdb_ssb
                                                WHERE helpid='".$get_aass_ksrl_helpid."';";
             $query_ssb_his =  mysqli_query($conn , $inset_ssb_his) or die(mysqli_error($conn));
            $sql_update_asing = "UPDATE `cdb_ssb` 
                                    SET `evaluate_assign_by`= '".$get_assuser."' 
                                  WHERE `helpid` = '".$get_aass_ksrl_helpid."';";
            $que_update_asing = mysqli_query($conn,$sql_update_asing) or die(mysqli_error($conn));
            
            $SQL_INSERT_REASSIGN = "INSERT INTO cdb_ssb_evaluate_reassign (helpid,entry_by,entry_on,evaluate_assign_by)
                                            VALUES(".$get_aass_ksrl_helpid.",'".$_SESSION['user']."',NOW(),'".$get_assuser."');";
            $quary_INSERT_REASSIGN = mysqli_query($conn,$SQL_INSERT_REASSIGN) or die(mysqli_error($conn));
            if($que_update_asing){
                echo "OK";
            }else{
                echo "NOT";
...
//------------------------------------------------------------------------------------------------------------------------ 
function isKioslFileEveluate($helpid,$user,$title){
    $conn = DatabaseConnection();
        //echo $get_UCL_appNUmber." - ".$get_UCL_app_ksrl_helpid." - ".$get_UCL_app_ksrl_user." - Function OK";
        mysqli_autocommit($conn,FALSE);
        try{
          ...
          if($title == "A"){
            $file_evaluate = 1;
            $S_e = "File Evaluate - Recommended";
          }else if($file_evaluate == "R"){
            $file_evaluate = 2;
            $S_e = "File Evaluate - Rejected";
          }else{
            $file_evaluate = 0;
            $S_e = "File Evaluate - ERROR";
          }
          if($file_evaluate != 0){
            $inset_ssb_his = "INSERT INTO cdb_ssb_his ( `helpid` ,`applicant_info` ,`clear_valuation`,`guarantor_1` ,`guarantor_2` ,`cr_copy_and_invoce`, `supplar_info` ,`pending_notification`,`histdate` ,`enuser`,`P_V`,`clcode`,`clcode_on`,`clcode_by`,`clcode_val`,`supcode`,`supcode_on`,`supcode_by`,`supcode_val`,`gar_code_1` ,`gar_code_1_on`,`gar_code_1_by`,`gar_code_1_val`,`gar_code_2` ,`gar_code_2_on` ,`gar_code_2_by` ,`gar_code_2_val` ,`gar_code_3` ,`gar_code_3_on` ,`gar_code_3_by` ,`gar_code_3_val`,`sec_no` ,`sec_no_on`,`sec_no_by` ,`sec_no_val` ,`supacc` ,`supacc_on` ,`supacc_by` ,`supacc_val` ,`recacc` ,`recacc_on` ,`recacc_by` ,`recacc_val` ,`C_Moble` ,`C_Client_name` ,`source_code` ,`source_code_by` ,`source_code_on` ,`file_evaluate` ,`file_evaluate_by`,`file_evaluate_on` , `evaluate_assign_by`, `evaluate_assign_on` , `cdpu_stat` , `cdpu_by` , `cdpu_on` )
                                               SELECT `helpid` ,`applicant_info` ,`clear_valuation`,`guarantor_1` ,`guarantor_2` ,`cr_copy_and_invoce`, `supplar_info` ,`pending_notification`,`histdate` ,`enuser`,`P_V`,`clcode`,`clcode_on`,`clcode_by`,`clcode_val`,`supcode`,`supcode_on`,`supcode_by`,`supcode_val`,`gar_code_1` ,`gar_code_1_on`,`gar_code_1_by`,`gar_code_1_val`,`gar_code_2` ,`gar_code_2_on` ,`gar_code_2_by` ,`gar_code_2_val` ,`gar_code_3` ,`gar_code_3_on` ,`gar_code_3_by` ,`gar_code_3_val`,`sec_no` ,`sec_no_on`,`sec_no_by` ,`sec_no_val` ,`supacc` ,`supacc_on` ,`supacc_by` ,`supacc_val` ,`recacc` ,`recacc_on` ,`recacc_by` ,`recacc_val` ,`C_Moble` ,`C_Client_name` ,`source_code` ,`source_code_by` ,`source_code_on` ,`file_evaluate` ,`file_evaluate_by`,`file_evaluate_on` , `evaluate_assign_by`, `evaluate_assign_on` ,  `cdpu_stat` , `cdpu_by` , `cdpu_on`
                                                FROM cdb_ssb
                                                WHERE helpid='".$helpid."';";
              $query_ssb_his =  mysqli_query($conn , $inset_ssb_his) or die(mysqli_error($conn));
              $sql_UpdateSSB = "UPDATE cdb_ssb 
                                SET file_evaluate = ".$file_evaluate." ,
                                    file_evaluate_by = '".$user."',
                                    file_evaluate_on = NOW()
                              WHERE helpid = '".$helpid."';";
             $query_UpdateSSB = mysqli_query($conn,$sql_UpdateSSB) or die(mysqli_error($conn));
                    $cou = 1;
                    ...
                    while($rec_select_note_count = mysqli_fetch_array($query_select_note_count)){
                        $cou = $rec_select_note_count[0] + 1;
                        $sql_note_update = "INSERT INTO `cdb_help_note`(`helpid`, `note_code`, `note_discr`, `enterBy`, `enterDateTime`,`NoteTag`) 
                                        VALUES (".$helpid.",'".$cou."',CONCAT('".$S_e." on ', now()),'".$user."',now(),'FILE_EVALUATE');";
                        //echo $sql_note_update;
                        $query_note_update = mysqli_query($conn,$sql_note_update) or die(mysqli_error($conn));
                    }
                    
                    
                    $SQL_CheckBlankAssign = "SELECT `user`.`GSMNO`,
                                                    `cdb_helpdesk`.`issue`,
                                             ...
                                             WHERE `user`.`userName` = `cdb_helpdesk`.enterBy
                                               ...
                                               AND `cdb_helpdesk`.`helpid` = '".$helpid."';";
                    ...
                    while($rec_CheckBlankAssign = mysqli_fetch_array($RS_CheckBlankAssign)){
                        $MESSAGE = "CDB Credit Evaluation. \n File :".$S_e . "in ERP \n REF ID : ".$helpid."\n Client : ".$rec_CheckBlankAssign[1]."\n Facility Amount : ".$rec_CheckBlankAssign[2];
                        $GENERATED_SOURCE = "FILE_EVALUATE";
                        SMSSender($conn , $rec_CheckBlankAssign[0] , $MESSAGE,$GENERATED_SOURCE);
                    }
                   ...
                   if($query_UpdateSSB && $query_note_update){
                        mysqli_commit($conn);
...
//------------------------------------------------------------------------------------------------------------------------ 
function isKioslFileEveluateF8($helpid,$user,$title){
    $conn = DatabaseConnection();
        //echo $get_UCL_appNUmber." - ".$get_UCL_app_ksrl_helpid." - ".$get_UCL_app_ksrl_user." - Function OK";
        mysqli_autocommit($conn,FALSE);
        try{
