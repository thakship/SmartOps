...
Page Name		: kiosk Service Request BRanch Request
...
<?php
    //echo $_SESSION['user']."--".$_SESSION['usergroupNumber'];
    $v_sql_det_detelsCNT = "SELECT * FROM `cdb_helpdesk`, `urgency_states`, `priority_states`, `cmb_states`, `branch`, `deparment`
...
<table border="1" cellpadding="0" cellspacing="0" id="myTable"  style="background:#FFFFFF;text-align:center; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
        <tr style="background-color: #BEBABA; font-size: 11; font-weight: bold;">
            ...
            <td style="width:160px;text-align: left;"><span style="margin-left: 5px;">SSB Type</span></td>
            <td style="width:60px;text-align: left;"><span style="margin-right: 5px;">Enter By</span></td>
            ...
            <td style="width:60px;text-align: left;"><span style="margin-right: 5px;">Assigned User</span></td>
            <td style="width:80px;text-align: left;"><span style="margin-right: 0px;">LOS Stage</span></td>
 ...
 // echo $v_sql_det_detels;
    ...
    while($rec_det_detels = mysqli_fetch_array($v_que_det_detels)){
       $sql_count_note = "SELECT COUNT(*) FROM `cdb_help_note` WHERE `helpid` = '".$rec_det_detels[0]."';";
        ...
        echo "<td style='width:160px;text-align: left;".$MyRow ."'><span style='margin-left: 2px;'>".$rec_det_detels[12]."</span></td>";
        ...
        /*Rizvi 2:08 PM 21/09/2015 below line*/
        echo "<td style='width:80px;text-align: right;".$MyRow ."' title ='".$rec_det_detels[18].chr(10).$rec_det_detels[19]."'><span style='margin-right: 2px;'>".$rec_det_detels[17]."</span></td>";        
		...
		echo "<td style='width:40px;text-align: left;' title =''><span style='margin-left: 5px;'>".$rec_det_detels[20]."</span></td>";		
        echo "</tr>";
    }
?>
</table>
