...
<table>
  <tr>
   ...
   <tr>
    ...
    <td>
        <input class="box_decaretion" type="text"  style="width:150px;" maxlength="15" placeholder="0.00" name="txt_facility_amount" id="txt_facility_amount" value="" onkeypress="return disableEnterKey(event)"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)" required="required" />
    </td>
  </tr>
  <tr>
    <td style="width: 150px; text-align: right;padding-right: 5px;"><label class="linetop">Client Information  :</label></td>
    <td>
        <input class="box_decaretion" type="text"  style="width:400px;" name="txt_issue" placeholder="Client name and NIC " id="txt_issue" value="" onkeypress="return disableEnterKey(event)"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)" required="required" /><label style="color: #cc0003;" class="linetop"> *** NIC is mandatory </label>
    </td>
  </tr>
  <tr>
