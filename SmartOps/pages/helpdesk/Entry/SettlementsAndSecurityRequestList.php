...
Page Name		: Settlements and Security Request List
Purpose			: To viwe Request list for Settlements and Security Request
...
function pageClose(){ //Page Close Function.......
    ...
    window.open('http://cdberp:8080/cdb/pages/helpdesk/Entry/SettlementsAndSecurityRequestList.php?DispName=Settlements%20And%20Security%20Request%20List','conectpage');
}
function pageRef(){
   window.open('http://cdberp:8080/cdb/pages/helpdesk/Entry/SettlementsAndSecurityRequestList.php?DispName=Settlements%20And%20Security%20Request%20List','conectpage');
}
...
function is_getScat_01(){
    ...
    if(cat1 == ""){
        ...
        mydata.open("GET","AJAX_SettlementsandSecurityRequestList.php"+"?getCatagorySetletment="+cat1,true);
        mydata.send();
    }
...
function getGried(){
    ...
    mydata.open("GET","AJAX_SettlementsandSecurityRequestList.php"+"?cat1="+cat1+"&scat1="+scat1+"&getUSERgROUP="+txt_USERgROUP+"&getUSERBRANCHNAME="+USERBRANCHNAME+"&userID="+userID,true);
    mydata.send();
}
</script>
<script>
  ...
  <tr>
    ...
    <td>
         <select class="box_decaretion"  style="width: 200px;" name="sel_catagory" id="sel_catagory" onkeypress="return disableEnterKey(event)"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)" onchange="is_getScat_01();">
            ...
            <option value="1">Settlement Request (Branch)</option>
            <option value="2">Settlement Request (Internal)</option>
            <option value="3">Facility to be Closed</option>
         </select>
    </td>
    <td>
        <div id="diva22">
...
<?php
 ...
 WHERE `cdb_helpdesk`.`ur_code` = `urgency_states`.`ur_code` AND
       ...
       `cdb_helpdesk`.`cat_code` = '1028' AND
