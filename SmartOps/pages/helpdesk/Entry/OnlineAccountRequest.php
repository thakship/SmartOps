...
Page Name		: Online Account Request
Purpose			: To Request for Online Account Request
Author			: Madushan Wikramaarachchi
Date & Time		: 05.00 PM 2017-12-21
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
	$_SESSION['page']="hel/e/029";
...
// ----- BY Madushan - 2017-12-26 ----- isNumberKey
function isNumberKey(evt)
      {
         var charCode = (evt.which) ? evt.which : event.keyCode
         if (charCode > 31 && (charCode < 48 || charCode > 57))
...
<form action="onlineACCUpload.php" method="post" id="uploadForm" name="uploadForm" enctype="multipart/form-data"> 
<p class="topline">
<?php 
...
<table>
  <tr>
    ...
    <td>
         <input class="box_decaretion" type="text" style="width:200px;" name="sel_catagory" id="sel_catagory" value='1032' onkeypress="return disableEnterKey(event)" readonly="readonly"/>
    </td>
    <td>
        <input class="box_decaretion" type="text" style="width:200px;" name="sel_scat01" id="sel_scat01" value='103201' onkeypress="return disableEnterKey(event)" readonly="readonly"/>
    </td>
    <td>
        <!--<input class="box_decaretion" type="text" style="width:200px;" name="sel_scat02" id="sel_scat02" value='10320101' onkeypress="return disableEnterKey(event)" readonly="readonly"/>-->
    </td>
    <td>
...
<table>
  <tr>
    <td style="width: 150px; text-align: right;padding-right: 5px;"><label class="linetop">File Type :</label></td>
    <td>
       <select class="box_decaretion"  style="width: 150px;" name="sel_scat02" id="sel_scat02" onkeypress="return disableEnterKey(event)"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)" onchange="getAdditionalBox()">
                    ...
                    <?php
                        ...
                        $v_sql_cat_2 = "SELECT `scat_code_2` , `scat_discr_2` FROM `scat_02` WHERE `cat_code` = '1032' AND `scat_code_1` = '103201';";
   ...
   <tr style="display: none;">
    ...
    <td>
        <input class="box_decaretion" type="text"  style="width:150px;" maxlength="15" placeholder="0.00" name="txt_facility_amount" id="txt_facility_amount" value="1.00" onkeypress="return disableEnterKey(event)"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)" required="required" /> <label style="color: #CC0000;">*</label>
    </td>
  </tr>
  <tr>
    <td style="width: 150px; text-align: right;padding-right: 5px;"><label class="linetop">Client Mobile No :</label></td>
    <td>
        <input class="box_decaretion" type="text"  style="width:150px;" maxlength="10" placeholder="Client Mobile No" name="txt_ClientMobileNo" id="txt_ClientMobileNo" value="" onkeypress="return isNumberKey(event)"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)" required="required" /> <label style="color: #CC0000;">*</label>
    </td>
  </tr>
  <tr>
    <td style="width: 150px; text-align: right;padding-right: 5px;"><label class="linetop">Client Name :</label></td>
    <td>
        <input class="box_decaretion" type="text"  style="width:250px;" placeholder="Client Client Name" name="txt_Client_Name" id="txt_Client_Name" value="" onkeypress="return disableEnterKey(event)"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)" required="required" /> <label style="color: #CC0000;">*</label>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td style="width: 150px; text-align: right;padding-right: 5px;"><label class="linetop">Client E-mail  :</label></td>
    <td>
        <input class="box_decaretion" type="text"  style="width:500px;" name="txt_issue" placeholder="Client E-mail" id="txt_issue" value="" onkeypress="return disableEnterKey(event)"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)" required="required" /> <label style="color: #CC0000;">*** E-mail is mandatory</label>
    </td>
  </tr>
  <tr>
    ...
    <td>
          <span id="textarea_id">
         <textarea class="box_decaretion" cols="47" rows="4" style="height:150px; width: 500px;" name="txt_Description" id="txt_Description" onkeypress="return disableEnterKey(event)"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)" required="required">
Client Full Name	: 
Address 	        : 
Mobile No	        :  
e-Mail	                : 
...
<table>
  ...
  <tr>
  <tr>
    <td style="width: 150px; text-align: right;"><label class="linetop">Secondry File :</label></td>
    <td>
       ...
       /* mysqli_autocommit($conn,FALSE);
        try{
            ...
            if(trim($_POST['sel_catagory']) != "" && trim($_POST['sel_scat01']) != "" && trim($_POST['sel_scat02']) != "" && trim($_POST['txt_issue']) != "" && trim($_POST['txt_Description']) != "" && trim($_POST['sel_States']) != "" && trim($_POST['sel_Urgency']) != "" && trim($_POST['sel_Priority'])){
                if(is_numeric($_POST['txt_facility_amount'])){
                     $TableID = "";
                $hetCheck = 0;
                ...
                if($getUploadStates == 1){
                    ...
                    if($getUploadStates == 2){
                        ...
                        if($getUploadStates == 3){
                            ...
                            $v_getSQL_insert = "INSERT INTO `cdb_helpdesk`(`helpid`, `cat_code`, `scat_code_1`, `scat_code_2`, `cmb_code`, `ur_code`, `pr_code`, `issue`, `help_discr`, `enterBy`, `enterDateTime`,`attachment_name`, `inner_brCode`, `inner_dept`, `inner_user`, `inner_remark`, `inner_get`,`entry_branch`,`entry_department`,`s_type`,`scat_code_3`,`asing_by`,`ipAddress`,`ssb_type`,`ssb_cycle`,`ssb_facility_amount`) 
                                                VALUES ('".$TableID."', '".trim($_POST['sel_catagory'])."', '".trim($_POST['sel_scat01'])."', '".trim($_POST['sel_scat02'])."', '".trim($_POST['sel_States'])."', '".trim($_POST['sel_Urgency'])."', '".trim($_POST['sel_Priority'])."', '".trim($_POST['txt_issue'])."', '".trim($_POST['txt_Description'])."', '".$_SESSION['user']."', now(),'".$getUploadStates."','".trim($_POST['txt_Branch'])."', '".trim($_POST['txt_Department'])."', '".trim($_POST['txt_inner_User1'])."','".trim($_POST['inner_Remark'])."','".$hetCheck."','".$_SESSION['userBranch']."','".$_SESSION['userDepartment']."','".trim($_POST['sel_Source'])."','".trim($_POST['sel_scat03'])."','".$usrDf."','".$_SESSION['userIP']."','Initial Submission',1,'".trim($_POST['txt_facility_amount'])."');";
                            ...
                            for($y = 1 ; $y <= trim($_POST['row_COUNT']) ; $y++){
                                if(trim($_POST['txtb'.$y])!= ""){
                                    $v_getSQL_Note =  "INSERT INTO `cdb_help_note`(`helpid`, `note_code`, `note_discr`, `enterBy`, `enterDateTime`) VALUES ('".$TableID."','".$y."',CONCAT('".trim($_POST['txtb'.$y])." on ', now()),'".$_SESSION['user']."',now());";
...
sendMailNuw($getmail,$title,$mail,$headers); 
               ...
               /* }else{
                    echo "<script> alert('Facility amount is invalied.');</script>";  
                }       
