...
if(isset($_REQUEST['getCatagorySetletment'])){
    ...
    getDropListSettalemtSecReqList($_REQUEST['getCatagorySetletment']);
}
...
function getDropListSettalemtSecReqList($getCatagorySetletment){
   // echo $getCatagorySetletment;
    ...
    if($getCatagorySetletment == 1){
        echo "<option value='10280101'>CR Request (Settlement)</option>";
        echo "<option value='10280119'>CR Request (Settlement) - Reopen</option>";
        echo "<option value='10280108'>Mortgage Loan Document Request</option>";
        echo "<option value='10280201'>Personal Loan Settlement</option>";
        echo "<option value='10280202'>Facility Closing Only (Branch)</option>";
        
       
    }else if ($getCatagorySetletment == 2){
        echo "<option value='10280115'>CR Request (Lease_Transfer)</option>";
        echo "<option value='10280118'>Facility Closing (One Day Payment)</option>";
        echo "<option value='10280112'>Facility Closing (Lease_Transfer)</option>";
        echo "<option value='10280113'>Facility Closing (Invoice_Settlement)</option>";
        
        
        
    }else if ($getCatagorySetletment == 3){
        echo "<option value='10280114'>Facility to be closed (Invoice_Settlement)</option>";
        echo "<option value='10280120'>Facility to be closed (Invoice)-Reopen</option>";
