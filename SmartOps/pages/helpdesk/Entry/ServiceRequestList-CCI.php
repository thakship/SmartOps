...
Page Name		: Service Request List - Call Center Inquiry
Purpose			: To viwe Request list for Service - Call Center Inquiry
...
<?php
 ...
 WHERE `cdb_helpdesk`.`ur_code` = `urgency_states`.`ur_code` AND
       ...
       `cdb_helpdesk`.`scat_code_1` = '102404' AND
       ".$where_2."
