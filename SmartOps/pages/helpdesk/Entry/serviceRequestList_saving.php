...
Page Name		: Service Request List - Verification Savings at Branch
...
<head>
    ...
    <script type="text/javascript">
        function pageClose(){ //Page Close Function.......
            ...
            window.open('http://cdberp:8080/cdb/pages/helpdesk/Entry/serviceRequestList_saving.php?DispName=Service%20Request%20List%20-%20Verification%20Savings%20A/C','conectpage');
        }
        function pageRef(){
            window.open('http://cdberp:8080/cdb/pages/helpdesk/Entry/serviceRequestList_saving.php?DispName=Service%20Request%20List%20-%20Verification%20Savings%20A/C','conectpage');
        }
...
$v_sql_det_detelsCNT = "SELECT COUNT(1) 
 ...
 WHERE `cdb_helpdesk`.`ur_code` = `urgency_states`.`ur_code` AND
       ...
       `cdb_helpdesk`.`scat_code_1` = '100517' AND
       ".$where_1."
