...
?>
		<?php
            $viewDoc = "SELECT b.branchNumber, b.branchName, b.br_code FROM branch b WHERE b.branchName like '%$x%' AND b.branchNumber != '1212' AND  b.branchNumber != '9522' AND b.branchNumber != '0001'
                        UNION ALL 
