...
<?php
 ...
 WHERE `cdb_helpdesk`.`ur_code` = `urgency_states`.`ur_code` AND
    ...
    while($rec_det_detels = mysqli_fetch_array($v_que_det_detels)){
        ...
        echo "<td style='width:80px;text-align: right;'><span style='margin-right: 2px;'>".$rec_det_detels[5]."</span></td>";
        echo "<td style='width:100px;text-align: left;' title = '".$entryBy."'><span style='margin-left: 2px;'>".$rec_det_detels[6]."</span></td>";
