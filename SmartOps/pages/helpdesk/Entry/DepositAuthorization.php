...
Page Name		: Deposit Authorization
Purpose			: To authorization for Deposit Role
Author			: Madushan Wikramaarachchi
Date & Time		: 02:05 A.M 19/02/2018
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
	$_SESSION['page']="hel/e/036";
...
function pageRef(){
   window.open('http://cdberp:8080/cdb/pages/helpdesk/Entry/DepositAuthorization.php?DispName=Deposit%20Role%20Authorization','conectpage');
}
    ...
    <?php
        $sql_get_gried = "SELECT car.index_id, 
                            ...
                            WHERE car.user_id = u.userName AND
                                  ...
                                  car.req_user_role IN ('CERUSE','FDACEO')  AND
                                  car.auth_by = '' AND
