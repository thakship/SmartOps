...
<title>Kiosk Service Request List</title>
...
function pageRef(){
   ...
   window.open('http://cdberp:8080/cdb/pages/helpdesk/Entry/kioskServiceRequestList.php?DispName=Kiosk%20Service%20Request%20List','conectpage');
    ...
    function clientValidatef8(title,cat_cod){
       // alert("A");
        var helpAdmin = document.getElementById('txt_helpdeskadmin').value;
        var helpClose = document.getElementById('txt_helpdesk_close').value;
            //alert(cat_cod);
            ...
            mydata.open("GET","../helpdesk_DEVELOPMENT/PHP_FUNCTION/helpdesk_Ajax.php"+"?getHelpIDreq1f8="+getHI+"&gettxt_helpdesk_close1f8="+helpClose,true);
            mydata.send();
        
        
    }

// ------------- Madushan LOS QUERE 2018-07-04    
function isEveluale(title){
    ...
    if (r==true){
		...
		$.ajax({ 
			type:'POST', 
			data: {get_F8_helpid : ksrl_helpid ,  get_F8_user : ksrl_user , get_F8title : title}, 
