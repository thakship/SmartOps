<?php
    ...
    $v_sql_det_detelsCNT = "SELECT COUNT(1) FROM `scat_02` , `cdb_helpdesk`, `urgency_states`, `priority_states`, `cmb_states`, `branch`, `deparment`,`cdb_help_user_oth`
 WHERE `cdb_helpdesk`.`scat_code_2` = `scat_02`.`scat_code_2` AND
	   ...
	   `scat_02`.`scat_discr_2` = '".$_REQUEST['n_SelectedValue']."'
