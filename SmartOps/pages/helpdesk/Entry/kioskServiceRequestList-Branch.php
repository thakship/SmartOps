...
Page Name		: kiosk Service Request List - Branch
Purpose			: To viwe Request kiosk list for Service Branch
Author			: Madushan Wikramaarachchi
Date & Time		: 12.04 P.M 09/06/2017
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
	$_SESSION['page']="hel/e/026";
...
<title>kiosk Service Request List - Branch</title>
...
function pageClose(){ //Page Close Function.......
    ...
    window.open('http://cdberp:8080/cdb/pages/helpdesk/Entry/kioskServiceRequestList-Branch.php?DispName=kiosk%20Service%20Request%20List%20-%20Branch','conectpage');
}
function pageRef(){
   window.open('http://cdberp:8080/cdb/pages/helpdesk/Entry/kioskServiceRequestList-Branch.php?DispName=kiosk%20Service%20Request%20List%20-%20Branch','conectpage');
}
    ...
    function clientValidate(title,cat_cod){
        ...
        if(cat_cod != '1014' ){
            ...
            mydata.open("GET","../helpdesk_DEVELOPMENT/PHP_FUNCTION/helpdesk_Ajax.php"+"?getHelpIDreqBranch="+getHI+"&gettxt_helpdesk_closeBranch="+helpClose,true);
            mydata.send();
        }
   ...
   if(key == 120){
      ...
      /* var mydataNew;
       ...
       var mydataNew;
		...
		mydataNew.open('GET','ajaxEntryNewGridBranch_F10.php'+'?n_userID='+userID+'&n_userg='+userg+'&getuserBranch='+userBranch,true);
		mydataNew.send();
       ...
       var mydataNew;
        ...
        var userg = document.getElementById('txt_USERgROUP').value;
        var userBranch = document.getElementById('UserBranch').value;
		mydataNew.open('GET','ajaxEntryNewGridBranch_F8.php'+'?n_userID='+userID+'&n_userg='+userg+'&getuserBranch='+userBranch,true);
		mydataNew.send();
    }
}
</script>
...
<span style="background:#FFFFFF;text-align:center; font-family:Arial, Helvetica, sans-serif; font-size:11px; font-weight:bold"><b>F8</b> - File Verified , <b>F10</b> - QC Pending </span>
