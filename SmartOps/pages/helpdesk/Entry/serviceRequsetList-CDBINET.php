...
Page Name		: Service Request List-CDBINET
...
function pageClose(){ //Page Close Function.......
    ...
    window.open('http://cdberp:8080/cdb/pages/helpdesk/Entry/serviceRequsetList-CDBINET.php?DispName=CDB%20iNet%20Activetion%20Request','conectpage');
}
function pageRef(){
   window.open('http://cdberp:8080/cdb/pages/helpdesk/Entry/serviceRequsetList-CDBINET.php?DispName=CDB%20iNet%20Activetion%20Request','conectpage');
}
...
<?php
 ...
 WHERE `cdb_helpdesk`.`ur_code` = `urgency_states`.`ur_code` AND
       ...
       `cdb_helpdesk`.`scat_code_1` = '102405' AND
