...
Page Name		: Acting Role Authorization
Purpose			: To authorization for Acting Role
...
function pageRef(){
   window.open('http://cdberp:8080/cdb/pages/helpdesk/Entry/actingRoleAuthorization.php?DispName=Acting%20Role%20Authorization','conectpage');
}
