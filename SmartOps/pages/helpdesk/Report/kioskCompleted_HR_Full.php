...
Page Name		: kiosk completed Report - new
Purpose			:  for completed kiosk - given period - new
Author			: Madushan Wikramaarachchi
Date & Time		: 02.55 P.M 25/05/2017
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
	$_SESSION['page']="hel/r/006";
...
function getGriedViwe(){
        ...
        if(getFromDate == ""){
            ...
            mydata.open("GET","ajax_report_helpdesk.php"+"?getKISCompteFromDate_Full="+getFromDate+"&getKISCompteToDate_Full="+getToDate,true);
            mydata.send();
        }
