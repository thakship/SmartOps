...
Page Name		: kiosk completed Report - new UCL
Purpose			:  for completed kiosk - given period - new UCL
Author			: Madushan Wikramaarachchi
Date & Time		: 09.06 A.M 09/06/2017
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
	$_SESSION['page']="hel/r/007";
...
function pageClose(){ //Page Close Function.......
    ...
    window.open('http://cdberp:8080/cdb/pages/helpdesk/Report/kioskCompleted_HR_UCL_Full.php?DispName=Kiosk%20Completed%20Report%20UCL%20-%20Hourly%20New','conectpage');
}
function pageRef(){
...
function getGriedViwe(){
        ...
        if(getFromDate == ""){
            ...
            mydata.open("GET","ajax_report_helpdesk.php"+"?getKISCompteFromDate_UCLFull="+getFromDate+"&getKISCompteToDate_UCLFull="+getToDate,true);
            mydata.send();
        }
