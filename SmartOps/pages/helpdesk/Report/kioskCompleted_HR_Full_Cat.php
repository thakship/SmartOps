...
Page Name		: kiosk completed Report - new 1 Cat V
Purpose			:  for completed kiosk - given period - new 1h
Author			: Madushan Wikramaarachchi
Date & Time		: 11.54 A.M 24/08/2017
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
	$_SESSION['page']="hel/r/010";
...
function getGriedViwe(){
        ...
        var getFileType = document.getElementById('sel_scat02').value;
        sel_scat02
        if(getFromDate == ""){
            ...
            mydata.open("GET","ajax_report_helpdesk.php"+"?getKISCompteFromDate_1FullCat="+getFromDate+"&getKISCompteToDate_1FullCat="+getToDate+"&getgetFileTypeCat="+getFileType,true);
            mydata.send();
        }
...
<table>
    ...
    <tr>
        <td style="width: 150px; text-align: right;"><label class="linetop">File Type :</label></td>
    <td>
