...
Date & Time		: 12:34 PM 30/06/2017
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
	$_SESSION['page']="hel/r/008";
...
function getGriedViwe(){
        ...
        if(getFromDate == ""){
            ...
            mydata.open("GET","ajax_kioskCompletedReoptScat2.php"+"?getKISCompteFromDate="+getFromDate+"&getKISCompteToDate="+getToDate+"&getScat02="+sel_scat02,true);
            mydata.send();
        }
