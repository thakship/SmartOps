                    ...
                    while($RES_Count = mysqli_fetch_array($q_select)){
                        if($RES_Count[0]!=0){
                            $v_update = "UPDATE `scat_02` 
                                            SET `scat_discr_2` = '".trim($_POST['txtb'.$i])."', `scat_state_2` = 1 , `DefuserID` = '".trim($_POST['txtc'.$i])."', `SLA_TYPE` = '".trim($_POST['txtd'.$i])."', `SAL` = '".trim($_POST['txte'.$i])."', `ESCAL_1_USER_ID` = '".trim($_POST['txtf'.$i])."', `ESCAL_1` = '".trim($_POST['txtg'.$i])."', `ESCAL_2_USER_ID` = '".trim($_POST['txth'.$i])."', `ESCAL_2` = '".trim($_POST['txti'.$i])."', `ESCAL_3_USER_ID` = '".trim($_POST['txtj'.$i])."', `ESCAL_3` = '".trim($_POST['txtj'.$i])."'
