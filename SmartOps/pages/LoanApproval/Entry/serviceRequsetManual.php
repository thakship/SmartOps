...
<title>Courier Day Receive  Report Manual</title>
                        ...
                        if($getUploadStates == 3){
                            ...
                            for($y = 1 ; $y <= trim($_POST['row_COUNT']) ; $y++){
                                if(trim($_POST['txtb'.$y])!= ""){
                                    $v_getSQL_Note =  "INSERT INTO `cdb_help_note`(`helpid`, `note_code`, `note_discr`, `enterBy`, `enterDateTime`) VALUES ('".$TableID."','".$y."','".trim($_POST['txtb'.$y])."','".$_SESSION['user']."',now());";
