...
Page Name		: Request Manager - Approved file
Purpose			: View Request List For Update Complete File 
Author			: Madushan Wikramaarachchi
Date & Time		: 11.21 A.M 12/01/2016
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
    $_SESSION['page']="lon/e/007";
...
<title>Request Manager - Approved file</title>
...
<?php
    ...
    $v_sql_select = "SELECT `helpid`, DATE(`enterDateTime`) AS getDate,`issue` 
                     ...
                     WHERE `loan_cdb_helpdesk`.`enterBy` = '".$_SESSION['user']."' AND 
                           `loan_cdb_helpdesk`.`cmb_code` = '5002' AND 
                           `loan_cdb_helpdesk`.`re_init_on` != '0000-00-00 00:00:00' AND
