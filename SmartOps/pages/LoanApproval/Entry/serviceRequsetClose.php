...
Page Name		: Service Request Request Manager
...
<?php
    ...
    $v_sql_select = "SELECT `helpid`, DATE(`enterDateTime`) AS getDate,`issue` 
                     ...
                     WHERE `loan_cdb_helpdesk`.`enterBy` = '".$_SESSION['user']."' AND `loan_cdb_helpdesk`.`cmb_code` IN ('5001','5000')";
    //echo $v_sql_select;
