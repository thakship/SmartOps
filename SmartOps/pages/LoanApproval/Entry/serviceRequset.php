...
<table>
  <tr>
    ...
    <td>
         <input class="box_decaretion" type="text" style="width:200px;" name="sel_catagory" id="sel_catagory" value='0' onkeypress="return disableEnterKey(event)" readonly="readonly"/>
    </td>
    <td>
        <input class="box_decaretion" type="text" style="width:200px;" name="sel_scat01" id="sel_scat01" value='0' onkeypress="return disableEnterKey(event)" readonly="readonly"/>
    </td>
    <td>
...
<table>
  <tr>
    <td style="width: 150px; text-align: right;padding-right: 5px;"><label class="linetop">Product Type :</label></td>
    <td>
       <select class="box_decaretion"  style="width: 150px;" name="sel_scat02" id="sel_scat02" onkeypress="return disableEnterKey(event)"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)">
                    ...
                    <?php
                        ...
                        $v_sql_cat_2 = "SELECT `product_id`, `product_name` FROM `loan_product`;";
  ...
  <tr>
    <td style="width: 150px; text-align: right; vertical-align: top;padding-right: 5px;"><label class="linetop">Loan Information :</label></td>
    <td>
         <textarea class="box_decaretion" cols="47" rows="5" style="height:130px; width: 400px; line-height: 1.7;" name="txt_Description" id="txt_Description" onkeypress="return disableEnterKey(event)"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)" required="required">
        ...
        <tr>
            ...
            <td>
                <select class="box_decaretion"  style="width: 200px;" name="sel_States" id="sel_States" onkeypress="return disableEnterKey(event)"  onfocus="hilightColoyr(this.id)" onblur="colourLeave(this.id)">
                    ...
                    <?php
                        //<option value="">--Select States --</option>
                        $v_sql_States = "SELECT `cmb_code`,`cmb_discr` FROM `cmb_states` WHERE `cmb_state` = 1 AND `cmb_code` = '5000' ;";
