<!------------------------------------------------------------------------------------------------------------------------
Module Code		: Leisure
Page Name		: Force Booking Cancelation 
Purpose			: To force booking Rooms Cancelation
Author			: Madushan Wikramaarachchi
Date & Time		: 09:11 AM 30/06/2017
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
	$_SESSION['page']="lei/e/007";
...
<script type="text/javascript">
    ...
    function pageRef(){
        window.open('http://cdberp:8080/cdb/pages/Leisure/Entry/ForceBookingCancelation.php?DispName=Force%20Booking%20Cancelation','conectpage');
    }
        ...
        if(fromDate > toDate){
            ...
            if (r==true){
    	      $.ajax({ 
    				...
    				url: 'functionForceBookingCancelation.php', 
