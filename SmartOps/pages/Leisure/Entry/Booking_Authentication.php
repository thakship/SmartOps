...
<table class="tbl1" border="1" cellpadding='0' cellspacing='0'>
      <tr style="background: #888888 ;">
        <td style="text-align: left; width:40px;"> <label style="margin-left:5px">Index</label></td>
        <td style="text-align:left;width:80px;"><label style="margin-left:5px">Booking ID</label></td>
        <td style="text-align:left;width:60px;"><label style="margin-left:5px">User ID</label></td>
        <td style="text-align:left; width:250px;"><label style="margin-left:5px">User Name</label></td>
        <td style="text-align:left;width:90px;"><label style="margin-left:5px">From Date</label></td>
        <td style="text-align:left; width:90px;"><label style="margin-left:5px">To Date</label></td>
        <td style="text-align:left;width:60px;"><label style="margin-left:5px">Rooms</label></td>
        <td style="text-align:left;width:60px;"><label style="margin-left:5px">Adults</label></td>
        <td style="text-align:left;width:60px;"><label style="margin-left:5px">Children</label></td>
        <td style="text-align:left; width:90px;"><label style="margin-left:5px">Entered on</label></td>
        <td style="text-align:left;width:60px;"><label style="margin-left:5px">Days</label></td>        
...
datediff(date(now()),DATE(`leisure_header`.`enteredDataTime`)) as agedays
from leisure_header, user 
where leisure_header.userName = user.userName and
 leisure_header.state ='P' ORDER BY leisure_header.fromDate";
 ...
 ?>
        <tr>
        <td style="text-align:left; width:40px;"><label style="margin-left:5px"><?php echo $index; ?></label></td>
        ...
        <td style="text-align:left; width:60px;"><label style="margin-left:5px">
        ...
        <td style="text-align:left; width:250px;"><label style="margin-left:5px"><?php echo $rec_selct_header[2]; ?></label></td>
        <td style="text-align:left; width:90px;"><label style="margin-left:5px"><?php echo $rec_selct_header[3]; ?></label></td>
        <td style="text-align:left; width:90x;"><label style="margin-left:5px"><?php echo $rec_selct_header[4]; ?></label></td>
        <td style="text-align:left; width:60px;"><label style="margin-left:5px"><?php echo $room_get; ?></label></td>
        <td style="text-align:left; width:60px;"><label style="margin-left:5px"><?php echo $rec_selct_header[6]; ?></label></td>
        <td style="text-align:left; width:60px;"><label style="margin-left:5px"><?php echo $rec_selct_header[7]; ?></label></td>
        <td style="text-align:left; width:90px;"><label style="margin-left:5px"><?php echo $rec_selct_header[8]; ?></label></td>
        <td style="text-align:left; width:60px;"><label style="margin-left:5px"><?php echo $rec_selct_header[9]; ?></label></td>
