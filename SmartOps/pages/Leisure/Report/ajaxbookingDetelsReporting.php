<?php
    ...
    if($Where!="")
        $Where = " WHERE leisure_header.userName = user.userName AND ".$Where;
    else
        $Where = " WHERE leisure_header.userName = user.userName";
...
?>
 <table class="tbl1" border="1" cellpadding='0' cellspacing='0'>
      <tr style="background: #888888 ;">
        ...
        <td style="text-align:left; padding-top:5px; padding-bottom:5;width:100px;"><label style="margin-left: 5px;">User ID</label></td>
...
<?php
 ...
 ?>
       <tr>
        ...
        <td style="text-align:left;   width:100px;"><label style="margin-left:5px;"> <?php echo $rec_selct_header[1]; ?></label></td>
