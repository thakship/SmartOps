<!------------------------------------------------------------------------------------------------------------------------
Module Code		: Leisure
Page Name		: Salray Deduction Reporting 
Purpose			: To Booking Management
Author			: Madushan Wikramaarachchi
Date & Time		: 05:20 PM 18/09/2014
------------------------------------------------------------------------------------------------------------------------->
<!-- Common Included -->
<?php
	session_start();
	$_SESSION['page']="lei/r/002";
...
<title>Salray Deduction Reporting</title>
...
<script type="text/javascript">
    ...
    function getdetails(){
		...
		mydata.open("GET","ajaxSalrayDeductionReporting.php"+"?fromDate="+V_FromDate+"&toDate="+V_ToDate+"&userID="+V_userId,true);
		mydata.send();
    }
</script>
<!-- Ends  function here -->
